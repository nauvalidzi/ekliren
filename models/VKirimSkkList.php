 ...
 * Page class
 */
class VKirimSkkList extends VKirimSkk
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "VKirimSkkList";

    // Rendering View
    public $RenderingView = false;

    // Grid form hidden field names
    public $FormName = "fv_kirim_skklist";
    ...
    public function __construct()
    {
        ...
        $this->AddUrl = "VKirimSkkAdd";
        $this->InlineAddUrl = $pageUrl . "action=add";
        $this->GridAddUrl = $pageUrl . "action=gridadd";
        $this->GridEditUrl = $pageUrl . "action=gridedit";
        $this->MultiDeleteUrl = "VKirimSkkDelete";
        $this->MultiUpdateUrl = "VKirimSkkUpdate";
        ...
        $this->FilterOptions->TagClassName = "ew-filter-option fv_kirim_skklistsrch";
    ...
    public function run()
    {
        ...
        $this->sk_bandng_nomor->Visible = false;
    ...
    public function getFilterList()
    {
        ...
        $filterList = Concat($filterList, $this->sk_bandng_nomor->AdvancedSearch->toJson(), ","); // Field sk_bandng_nomor
        ...
        $filterList = Concat($filterList, $this->hasil_acc->AdvancedSearch->toJson(), ","); // Field hasil_acc
    ...
    protected function processFilterList()
    {
        ...
        if (Post("ajax") == "savefilters") { // Save filter request (Ajax)
            ...
            $UserProfile->setSearchFilters(CurrentUserName(), "fv_kirim_skklistsrch", $filters);
    ...
    protected function restoreFilterList()
    {
        ...
        // Field sk_bandng_nomor
        $this->sk_bandng_nomor->AdvancedSearch->SearchValue = @$filter["x_sk_bandng_nomor"];
        $this->sk_bandng_nomor->AdvancedSearch->SearchOperator = @$filter["z_sk_bandng_nomor"];
        $this->sk_bandng_nomor->AdvancedSearch->SearchCondition = @$filter["v_sk_bandng_nomor"];
        $this->sk_bandng_nomor->AdvancedSearch->SearchValue2 = @$filter["y_sk_bandng_nomor"];
        $this->sk_bandng_nomor->AdvancedSearch->SearchOperator2 = @$filter["w_sk_bandng_nomor"];
        $this->sk_bandng_nomor->AdvancedSearch->save();
        ...
        // Field hasil_acc
        $this->hasil_acc->AdvancedSearch->SearchValue = @$filter["x_hasil_acc"];
        $this->hasil_acc->AdvancedSearch->SearchOperator = @$filter["z_hasil_acc"];
        $this->hasil_acc->AdvancedSearch->SearchCondition = @$filter["v_hasil_acc"];
        $this->hasil_acc->AdvancedSearch->SearchValue2 = @$filter["y_hasil_acc"];
        $this->hasil_acc->AdvancedSearch->SearchOperator2 = @$filter["w_hasil_acc"];
        $this->hasil_acc->AdvancedSearch->save();
    ...
    protected function basicSearchSql($arKeywords, $type)
    {
        ...
        $this->buildBasicSearchSql($where, $this->sk_bandng_nomor, $arKeywords, $type);
        ...
        $this->buildBasicSearchSql($where, $this->hasil_acc, $arKeywords, $type);
    ...
    protected function setupOtherOptions()
    {
        ...
        $item->Body = "<a class=\"ew-save-filter\" data-form=\"fv_kirim_skklistsrch\" href=\"#\" onclick=\"return false;\">" . $Language->phrase("SaveCurrentFilter") . "</a>";
        $item->Visible = true;
        $item = &$this->FilterOptions->add("deletefilter");
        $item->Body = "<a class=\"ew-delete-filter\" data-form=\"fv_kirim_skklistsrch\" href=\"#\" onclick=\"return false;\">" . $Language->phrase("DeleteFilter") . "</a>";
        $item->Visible = true;
    ...
    public function renderOtherOptions()
    {
        ...
        foreach ($this->ListActions->Items as $listaction) {
            if ($listaction->Select == ACTION_MULTIPLE) {
                ...
                $item->Body = '<a class="ew-action ew-list-action" title="' . HtmlEncode($caption) . '" data-caption="' . HtmlEncode($caption) . '" href="#" onclick="return ew.submitAction(event,jQuery.extend({f:document.fv_kirim_skklist},' . $listaction->toJson(true) . '));">' . $icon . '</a>';
    ...
    protected function setupSearchOptions()
    {
        ...
        $item->Body = "<a class=\"btn btn-default ew-search-toggle" . $searchToggleClass . "\" href=\"#\" role=\"button\" title=\"" . $Language->phrase("SearchPanel") . "\" data-caption=\"" . $Language->phrase("SearchPanel") . "\" data-toggle=\"button\" data-form=\"fv_kirim_skklistsrch\" aria-pressed=\"" . ($searchToggleClass == " active" ? "true" : "false") . "\">" . $Language->phrase("SearchLink") . "</a>";
        $item->Visible = true;
    ...
    public function listOptionsRendered()
    {
        ...
        $this->ListOptions->Items["print"]->Body = "<a href=\"./PrintSkk?id={$this->id_request->CurrentValue}&signature=true\" target=\"_blank\" class=\"btn btn-dark btn-sm\" title=\"Print with signature\"><i class=\"fas fa-file-signature\"></i> Print</a>";
