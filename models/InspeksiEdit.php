 ...
 * Page class
 */
class InspeksiEdit extends Inspeksi
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "InspeksiEdit";
        ...
        switch ($this->CurrentAction) {
            case "show": // Get a record to display
                if (!$loaded) { // Load record based on key
                    ...
                    $this->terminate("InspeksiList"); // No matching record, return to list
                    return;
                }
                break;
            case "update": // Update
                $returnUrl = $this->getReturnUrl();
                if (GetPageName($returnUrl) == "InspeksiList") {
    ...
    protected function setupBreadcrumb()
    {
        ...
        $url = CurrentUrl();
        $Breadcrumb->add("list", $this->TableVar, $this->addMasterUrl("InspeksiList"), "", $this->TableVar, true);
        $pageId = "edit";
