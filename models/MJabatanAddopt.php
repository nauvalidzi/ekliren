 ...
 * Page class
 */
class MJabatanAddopt extends MJabatan
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "MJabatanAddopt";
    ...
    protected function loadFormValues()
    {
        ...
        if (!$this->nama_jabatan->IsDetailKey) {
            $this->nama_jabatan->setFormValue(ConvertFromUtf8($val));
        }
    ...
    {
        global $CurrentForm;
        $this->nama_jabatan->CurrentValue = ConvertToUtf8($this->nama_jabatan->FormValue);
    }
