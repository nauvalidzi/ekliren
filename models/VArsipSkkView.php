 ...
 * Page class
 */
class VArsipSkkView extends VArsipSkk
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "VArsipSkkView";
    ...
    public function run()
    {
        ...
        if ($this->isPageRequest()) { // Validate request
            if (($keyValue = Get("id_request") ?? Route("id_request")) !== null) {
                ...
                $returnUrl = "VArsipSkkList"; // Return to list
            }
            ...
            switch ($this->CurrentAction) {
                case "show": // Get a record to display
                    ...
                    if (!$res) { // Load record based on key
                        ...
                        $returnUrl = "VArsipSkkList"; // No matching record, return to list
                    }
                    break;
            }
        } else {
            $returnUrl = "VArsipSkkList"; // Not page request, return to list
        }
        if ($returnUrl != "") {
    ...
    protected function setupBreadcrumb()
    {
        ...
        $url = CurrentUrl();
        $Breadcrumb->add("list", $this->TableVar, $this->addMasterUrl("VArsipSkkList"), "", $this->TableVar, true);
        $pageId = "view";
    ...
    public function pageRender()
    {
        ...
        if ($this->kategori_pemohon->CurrentValue == 'Wajib LHKPN') {
            ...
            $this->scan_lhkpn->ViewValue = "<a href=\"#\" class=\"view-file\" data-status=\"lhkpn\">{$this->scan_lhkpn->CurrentValue}</a>";
        } else {
            $this->scan_lhkpn->Visible = false;
            $this->scan_lhkasn->ViewValue = "<a href=\"#\" class=\"view-file\" data-status=\"lhkasn\">{$this->scan_lhkasn->CurrentValue}</a>";
        }
        $this->hasil_acc->ViewValue = "<a href=\"#\" class=\"view-file\" data-status=\"hasil_acc\">{$this->hasil_acc->CurrentValue}</a>";
    }
