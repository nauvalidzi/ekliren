 ...
 * Page class
 */
class DataUserView extends DataUser
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "DataUserView";
    ...
    public function run()
    {
        ...
        if ($this->isPageRequest()) { // Validate request
            if (($keyValue = Get("id_user") ?? Route("id_user")) !== null) {
                ...
                $returnUrl = "DataUserList"; // Return to list
            }
            ...
            switch ($this->CurrentAction) {
                case "show": // Get a record to display
                    ...
                    if (!$res) { // Load record based on key
                        ...
                        $returnUrl = "DataUserList"; // No matching record, return to list
                    }
                    break;
            }
        } else {
            $returnUrl = "DataUserList"; // Not page request, return to list
        }
        if ($returnUrl != "") {
