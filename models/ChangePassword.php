 ...
 * Page class
 */
class ChangePassword extends DataUser
{
    use MessagesTrait;
    ...
    public function run()
    {
        ...
        $this->OldPassword = new DbField("data_user", "data_user", "opwd", "opwd", "opwd", "", 202, 255, 0, false, "", false, false, false);
        $this->OldPassword->EditAttrs->appendClass("form-control ew-control");
        $this->NewPassword = new DbField("data_user", "data_user", "npwd", "npwd", "npwd", "", 202, 255, 0, false, "", false, false, false);
        $this->NewPassword->EditAttrs->appendClass("form-control ew-control");
        $this->ConfirmPassword = new DbField("data_user", "data_user", "cpwd", "cpwd", "cpwd", "", 202, 255, 0, false, "", false, false, false);
