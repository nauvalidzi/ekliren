...
class CetakSkk
{
    ...
    // Table name
    public $TableName = 'cetak_skk.php';

    // Page object name
    public $PageObjName = "CetakSkk";
    ...
    public function __construct()
    {
        ...
        if (!defined(PROJECT_NAMESPACE . "TABLE_NAME")) {
            define(PROJECT_NAMESPACE . "TABLE_NAME", 'cetak_skk.php');
        }
    ...
    protected function setupBreadcrumb()
    {
        ...
        $Breadcrumb->add("custom", "cetak_skk", CurrentUrl(), "", "cetak_skk", true);
        $this->Heading = $Language->TablePhrase("cetak_skk", "TblCaption");
    }
