...
class Login extends DataUser
{
    ...
    public function run()
    {
        ...
        $this->Username = new DbField("data_user", "data_user", "username", "username", "username", "", 202, 255, 0, false, "", false, false, false);
        $this->Username->EditAttrs->appendClass("form-control ew-control");
        $this->Password = new DbField("data_user", "data_user", "password", "password", "password", "", 202, 255, 0, false, "", false, false, false);
        $this->Password->EditAttrs->appendClass("form-control ew-control");
        if (Config("ENCRYPTED_PASSWORD")) {
            $this->Password->Raw = true;
        }
        $this->LoginType = new DbField("data_user", "data_user", "type", "logintype", "logintype", "", 202, 255, 0, false, "", false, false, false);
    ...
    public function pageDataRendering(&$header)
    {
        // Example:
        //$header = "your header";
        $header = '<br><br><br><br><br><br><br>	<h1 align="center" width="60%" style="
        background: rgba;
        width: 500px;
        position: relative;
        left: 50%;
