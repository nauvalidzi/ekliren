 ...
 * Page class
 */
class HukumanDisiplinDelete extends HukumanDisiplin
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "HukumanDisiplinDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("HukumanDisiplinList"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                ...
                $this->terminate("HukumanDisiplinList"); // Return to list
                return;
            }
        }
