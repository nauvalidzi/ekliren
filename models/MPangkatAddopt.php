 ...
 * Page class
 */
class MPangkatAddopt extends MPangkat
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "MPangkatAddopt";
    ...
    protected function loadFormValues()
    {
        ...
        if (!$this->pangkat->IsDetailKey) {
            $this->pangkat->setFormValue(ConvertFromUtf8($val));
        }
    ...
    {
        global $CurrentForm;
        $this->pangkat->CurrentValue = ConvertToUtf8($this->pangkat->FormValue);
    }
