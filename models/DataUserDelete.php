 ...
 * Page class
 */
class DataUserDelete extends DataUser
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "DataUserDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("DataUserList"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                ...
                $this->terminate("DataUserList"); // Return to list
                return;
            }
        }
