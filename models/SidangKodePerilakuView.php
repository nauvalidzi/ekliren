 ...
 * Page class
 */
class SidangKodePerilakuView extends SidangKodePerilaku
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "SidangKodePerilakuView";
    ...
    public function run()
    {
        ...
        if ($this->isPageRequest()) { // Validate request
            if (($keyValue = Get("id") ?? Route("id")) !== null) {
                ...
                $returnUrl = "SidangKodePerilakuList"; // Return to list
            }
            ...
            switch ($this->CurrentAction) {
                case "show": // Get a record to display
                    ...
                    if (!$res) { // Load record based on key
                        ...
                        $returnUrl = "SidangKodePerilakuList"; // No matching record, return to list
                    }
                    break;
            }
        } else {
            $returnUrl = "SidangKodePerilakuList"; // Not page request, return to list
        }
        if ($returnUrl != "") {
