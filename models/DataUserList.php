 ...
 * Page class
 */
class DataUserList extends DataUser
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "DataUserList";

    // Rendering View
    public $RenderingView = false;

    // Grid form hidden field names
    public $FormName = "fdata_userlist";
    ...
    public function __construct()
    {
        ...
        $this->AddUrl = "DataUserAdd";
        $this->InlineAddUrl = $pageUrl . "action=add";
        $this->GridAddUrl = $pageUrl . "action=gridadd";
        $this->GridEditUrl = $pageUrl . "action=gridedit";
        $this->MultiDeleteUrl = "DataUserDelete";
        $this->MultiUpdateUrl = "DataUserUpdate";
        ...
        $this->FilterOptions->TagClassName = "ew-filter-option fdata_userlistsrch";
    ...
    public function getFilterList()
    {
        ...
        $filterList = Concat($filterList, $this->email_satker->AdvancedSearch->toJson(), ","); // Field email_satker
        $filterList = Concat($filterList, $this->hak_akses->AdvancedSearch->toJson(), ","); // Field hak_akses
        if ($this->BasicSearch->Keyword != "") {
    ...
    protected function processFilterList()
    {
        ...
        if (Post("ajax") == "savefilters") { // Save filter request (Ajax)
            ...
            $UserProfile->setSearchFilters(CurrentUserName(), "fdata_userlistsrch", $filters);
    ...
    protected function restoreFilterList()
    {
        ...
        // Field email_satker
        $this->email_satker->AdvancedSearch->SearchValue = @$filter["x_email_satker"];
        $this->email_satker->AdvancedSearch->SearchOperator = @$filter["z_email_satker"];
        $this->email_satker->AdvancedSearch->SearchCondition = @$filter["v_email_satker"];
        $this->email_satker->AdvancedSearch->SearchValue2 = @$filter["y_email_satker"];
        $this->email_satker->AdvancedSearch->SearchOperator2 = @$filter["w_email_satker"];
        $this->email_satker->AdvancedSearch->save();

        // Field hak_akses
        $this->hak_akses->AdvancedSearch->SearchValue = @$filter["x_hak_akses"];
        $this->hak_akses->AdvancedSearch->SearchOperator = @$filter["z_hak_akses"];
        $this->hak_akses->AdvancedSearch->SearchCondition = @$filter["v_hak_akses"];
        $this->hak_akses->AdvancedSearch->SearchValue2 = @$filter["y_hak_akses"];
        $this->hak_akses->AdvancedSearch->SearchOperator2 = @$filter["w_hak_akses"];
        $this->hak_akses->AdvancedSearch->save();
    ...
    protected function basicSearchSql($arKeywords, $type)
    {
        ...
        $this->buildBasicSearchSql($where, $this->email_satker, $arKeywords, $type);
        $this->buildBasicSearchSql($where, $this->hak_akses, $arKeywords, $type);
        return $where;
    }
    ...
    protected function setupSortOrder()
    {
        ...
        if (Get("order") !== null) {
            ...
            $this->updateSort($this->email_satker); // email_satker
            $this->updateSort($this->hak_akses); // hak_akses
    ...
    protected function resetCmd()
    {
        ...
        if (StartsString("reset", $this->Command)) {
            ...
            if ($this->Command == "resetsort") {
                ...
                $this->email_satker->setSort("");
                $this->hak_akses->setSort("");
            }
    ...
    protected function setupOtherOptions()
    {
        ...
        $item->Body = "<a class=\"ew-save-filter\" data-form=\"fdata_userlistsrch\" href=\"#\" onclick=\"return false;\">" . $Language->phrase("SaveCurrentFilter") . "</a>";
        $item->Visible = true;
        $item = &$this->FilterOptions->add("deletefilter");
        $item->Body = "<a class=\"ew-delete-filter\" data-form=\"fdata_userlistsrch\" href=\"#\" onclick=\"return false;\">" . $Language->phrase("DeleteFilter") . "</a>";
        $item->Visible = true;
    ...
    public function renderOtherOptions()
    {
        ...
        foreach ($this->ListActions->Items as $listaction) {
            if ($listaction->Select == ACTION_MULTIPLE) {
                ...
                $item->Body = '<a class="ew-action ew-list-action" title="' . HtmlEncode($caption) . '" data-caption="' . HtmlEncode($caption) . '" href="#" onclick="return ew.submitAction(event,jQuery.extend({f:document.fdata_userlist},' . $listaction->toJson(true) . '));">' . $icon . '</a>';
    ...
    protected function setupSearchOptions()
    {
        ...
        $item->Body = "<a class=\"btn btn-default ew-search-toggle" . $searchToggleClass . "\" href=\"#\" role=\"button\" title=\"" . $Language->phrase("SearchPanel") . "\" data-caption=\"" . $Language->phrase("SearchPanel") . "\" data-toggle=\"button\" data-form=\"fdata_userlistsrch\" aria-pressed=\"" . ($searchToggleClass == " active" ? "true" : "false") . "\">" . $Language->phrase("SearchLink") . "</a>";
        $item->Visible = true;
