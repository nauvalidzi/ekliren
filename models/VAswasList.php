 ...
 * Page class
 */
class VAswasList extends VAswas
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "VAswasList";

    // Rendering View
    public $RenderingView = false;

    // Grid form hidden field names
    public $FormName = "fv_aswaslist";
    ...
    public function __construct()
    {
        ...
        $this->AddUrl = "VAswasAdd";
        $this->InlineAddUrl = $pageUrl . "action=add";
        $this->GridAddUrl = $pageUrl . "action=gridadd";
        $this->GridEditUrl = $pageUrl . "action=gridedit";
        $this->MultiDeleteUrl = "VAswasDelete";
        $this->MultiUpdateUrl = "VAswasUpdate";
        ...
        $this->FilterOptions->TagClassName = "ew-filter-option fv_aswaslistsrch";
    ...
    protected function processFilterList()
    {
        ...
        if (Post("ajax") == "savefilters") { // Save filter request (Ajax)
            ...
            $UserProfile->setSearchFilters(CurrentUserName(), "fv_aswaslistsrch", $filters);
    ...
    {
        $where = "";
        $this->buildBasicSearchSql($where, $this->tanggal_request, $arKeywords, $type);
    ...
    protected function setupOtherOptions()
    {
        ...
        $item->Body = "<a class=\"ew-save-filter\" data-form=\"fv_aswaslistsrch\" href=\"#\" onclick=\"return false;\">" . $Language->phrase("SaveCurrentFilter") . "</a>";
        $item->Visible = true;
        $item = &$this->FilterOptions->add("deletefilter");
        $item->Body = "<a class=\"ew-delete-filter\" data-form=\"fv_aswaslistsrch\" href=\"#\" onclick=\"return false;\">" . $Language->phrase("DeleteFilter") . "</a>";
        $item->Visible = true;
    ...
    public function renderOtherOptions()
    {
        ...
        foreach ($this->ListActions->Items as $listaction) {
            if ($listaction->Select == ACTION_MULTIPLE) {
                ...
                $item->Body = '<a class="ew-action ew-list-action" title="' . HtmlEncode($caption) . '" data-caption="' . HtmlEncode($caption) . '" href="#" onclick="return ew.submitAction(event,jQuery.extend({f:document.fv_aswaslist},' . $listaction->toJson(true) . '));">' . $icon . '</a>';
    ...
    protected function setupSearchOptions()
    {
        ...
        $item->Body = "<a class=\"btn btn-default ew-search-toggle" . $searchToggleClass . "\" href=\"#\" role=\"button\" title=\"" . $Language->phrase("SearchPanel") . "\" data-caption=\"" . $Language->phrase("SearchPanel") . "\" data-toggle=\"button\" data-form=\"fv_aswaslistsrch\" aria-pressed=\"" . ($searchToggleClass == " active" ? "true" : "false") . "\">" . $Language->phrase("SearchLink") . "</a>";
        $item->Visible = true;
    ...
    public function listOptionsRendered()
    {
        ...
        $this->ListOptions->Items["print"]->Body = "<div class=\"btn-group btn-group-sm\" role=\"group\" aria-label=\"Small button group\">
            <a href=\"./PrintSkk?id={$this->id_request->CurrentValue}\" target=\"_blank\" class=\"btn btn-success\" title=\"Print without signature & without initials\"><i class=\"fas fa-file-signature\"></i> Print</a>
            <a href=\"./PrintSkk?id={$this->id_request->CurrentValue}&signature=true\" target=\"_blank\" class=\"btn btn-dark\" title=\"Print with signature & without initials\"><i class=\"fas fa-file-signature\"></i> Print</a>
            <a href=\"./PrintSkk?id={$this->id_request->CurrentValue}&signature=false&initials=true\" target=\"_blank\" class=\"btn btn-primary\" title=\"Print without signature & with initials\"><i class=\"fas fa-file-contract\"></i> Print</a>
          </div>";
