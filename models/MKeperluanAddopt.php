 ...
 * Page class
 */
class MKeperluanAddopt extends MKeperluan
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "MKeperluanAddopt";
    ...
    protected function loadFormValues()
    {
        ...
        if (!$this->keperluan->IsDetailKey) {
            $this->keperluan->setFormValue(ConvertFromUtf8($val));
        }
    ...
    {
        global $CurrentForm;
        $this->keperluan->CurrentValue = ConvertToUtf8($this->keperluan->FormValue);
    }
