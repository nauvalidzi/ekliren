 ...
 * Page class
 */
class VPemeriksaEdit extends VPemeriksa
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "VPemeriksaEdit";
        ...
        switch ($this->CurrentAction) {
            case "show": // Get a record to display
                if (!$loaded) { // Load record based on key
                    ...
                    $this->terminate("VPemeriksaList"); // No matching record, return to list
                    return;
                }
                break;
            case "update": // Update
                $returnUrl = $this->getReturnUrl();
                if (GetPageName($returnUrl) == "VPemeriksaList") {
    ...
    protected function loadFormValues()
    {
        ...
        if (!$this->tanggal_request->IsDetailKey) {
            ...
            $this->tanggal_request->CurrentValue = UnFormatDateTime($this->tanggal_request->CurrentValue, 111);
        }
    ...
    protected function setupBreadcrumb()
    {
        ...
        $url = CurrentUrl();
        $Breadcrumb->add("list", $this->TableVar, $this->addMasterUrl("VPemeriksaList"), "", $this->TableVar, true);
        $pageId = "edit";
