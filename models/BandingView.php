 ...
 * Page class
 */
class BandingView extends Banding
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "BandingView";
    ...
    public function run()
    {
        ...
        if ($this->isPageRequest()) { // Validate request
            if (($keyValue = Get("id") ?? Route("id")) !== null) {
                ...
                $returnUrl = "BandingList"; // Return to list
            }
            ...
            switch ($this->CurrentAction) {
                case "show": // Get a record to display
                    ...
                    if (!$res) { // Load record based on key
                        ...
                        $returnUrl = "BandingList"; // No matching record, return to list
                    }
                    break;
            }
        } else {
            $returnUrl = "BandingList"; // Not page request, return to list
        }
        if ($returnUrl != "") {
