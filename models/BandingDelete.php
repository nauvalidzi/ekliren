 ...
 * Page class
 */
class BandingDelete extends Banding
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "BandingDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("BandingList"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                ...
                $this->terminate("BandingList"); // Return to list
                return;
            }
        }
