...
/**
 * Table class for m_keperluan
 */
class MKeperluan extends DbTable
{
    protected $SqlFrom = "";
    ...
    public function __construct()
    {
        ...
        $this->TableVar = 'm_keperluan';
        $this->TableName = 'm_keperluan';
        $this->TableType = 'TABLE';

        // Update Table
        $this->UpdateTable = "`m_keperluan`";
        $this->Dbid = 'DB';
        $this->ExportAll = true;
    ...
    {
        return ($this->SqlFrom != "") ? $this->SqlFrom : "`m_keperluan`";
    }
    ...
    public function getReturnUrl()
    {
        ...
        return $_SESSION[$name] ?? GetUrl("MKeperluanList");
    }
    ...
    {
        global $Language;
        if ($pageName == "MKeperluanView") {
            return $Language->phrase("View");
        } elseif ($pageName == "MKeperluanEdit") {
            return $Language->phrase("Edit");
        } elseif ($pageName == "MKeperluanAdd") {
    ...
    public function getApiPageName($action)
    {
        switch (strtolower($action)) {
            case Config("API_VIEW_ACTION"):
                return "MKeperluanView";
            case Config("API_ADD_ACTION"):
                return "MKeperluanAdd";
            case Config("API_EDIT_ACTION"):
                return "MKeperluanEdit";
            case Config("API_DELETE_ACTION"):
                return "MKeperluanDelete";
            case Config("API_LIST_ACTION"):
                return "MKeperluanList";
            default:
                return "";
        }
    }
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("MKeperluanView", $this->getUrlParm($parm));
        } else {
            $url = $this->keyUrl("MKeperluanView", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
        }
    ...
    {
        if ($parm != "") {
            $url = "MKeperluanAdd?" . $this->getUrlParm($parm);
        } else {
            $url = "MKeperluanAdd";
        }
        return $this->addMasterUrl($url);
    ...
    {
        $url = $this->keyUrl("MKeperluanEdit", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("MKeperluanAdd", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        return $this->keyUrl("MKeperluanDelete", $this->getUrlParm());
    }
