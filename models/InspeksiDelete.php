 ...
 * Page class
 */
class InspeksiDelete extends Inspeksi
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "InspeksiDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("InspeksiList"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                ...
                $this->terminate("InspeksiList"); // Return to list
                return;
            }
        }
