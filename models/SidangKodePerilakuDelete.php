 ...
 * Page class
 */
class SidangKodePerilakuDelete extends SidangKodePerilaku
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "SidangKodePerilakuDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("SidangKodePerilakuList"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                ...
                $this->terminate("SidangKodePerilakuList"); // Return to list
                return;
            }
        }
