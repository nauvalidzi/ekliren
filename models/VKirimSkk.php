...
/**
 * Table class for v_kirim_skk
 */
class VKirimSkk extends DbTable
{
    protected $SqlFrom = "";
    ...
    public function __construct()
    {
        ...
        $this->TableVar = 'v_kirim_skk';
        $this->TableName = 'v_kirim_skk';
        $this->TableType = 'VIEW';

        // Update Table
        $this->UpdateTable = "`v_kirim_skk`";
        $this->Dbid = 'DB';
        $this->ExportAll = true;
        ...
        // id_request
        $this->id_request = new DbField('v_kirim_skk', 'v_kirim_skk', 'x_id_request', 'id_request', '`id_request`', '`id_request`', 20, 20, -1, false, '`id_request`', false, false, false, 'FORMATTED TEXT', 'NO');
        ...
        // tanggal_request
        $this->tanggal_request = new DbField('v_kirim_skk', 'v_kirim_skk', 'x_tanggal_request', 'tanggal_request', '`tanggal_request`', CastDateFieldForLike("`tanggal_request`", 117, "DB"), 135, 19, 117, false, '`tanggal_request`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // nip
        $this->nip = new DbField('v_kirim_skk', 'v_kirim_skk', 'x_nip', 'nip', '`nip`', '`nip`', 200, 255, -1, false, '`nip`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // nrp
        $this->nrp = new DbField('v_kirim_skk', 'v_kirim_skk', 'x_nrp', 'nrp', '`nrp`', '`nrp`', 200, 255, -1, false, '`nrp`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // nama
        $this->nama = new DbField('v_kirim_skk', 'v_kirim_skk', 'x_nama', 'nama', '`nama`', '`nama`', 200, 255, -1, false, '`nama`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // pangkat
        $this->pangkat = new DbField('v_kirim_skk', 'v_kirim_skk', 'x_pangkat', 'pangkat', '`pangkat`', '`pangkat`', 3, 11, -1, false, '`pangkat`', false, false, false, 'FORMATTED TEXT', 'SELECT');
        ...
        // jabatan
        $this->jabatan = new DbField('v_kirim_skk', 'v_kirim_skk', 'x_jabatan', 'jabatan', '`jabatan`', '`jabatan`', 3, 11, -1, false, '`jabatan`', false, false, false, 'FORMATTED TEXT', 'SELECT');
        ...
        // unit_organisasi
        $this->unit_organisasi = new DbField('v_kirim_skk', 'v_kirim_skk', 'x_unit_organisasi', 'unit_organisasi', '`unit_organisasi`', '`unit_organisasi`', 3, 11, -1, false, '`unit_organisasi`', false, false, false, 'FORMATTED TEXT', 'SELECT');
        ...
        // scan_lhkpn
        $this->scan_lhkpn = new DbField('v_kirim_skk', 'v_kirim_skk', 'x_scan_lhkpn', 'scan_lhkpn', '`scan_lhkpn`', '`scan_lhkpn`', 200, 255, -1, false, '`scan_lhkpn`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // scan_lhkasn
        $this->scan_lhkasn = new DbField('v_kirim_skk', 'v_kirim_skk', 'x_scan_lhkasn', 'scan_lhkasn', '`scan_lhkasn`', '`scan_lhkasn`', 200, 255, -1, false, '`scan_lhkasn`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // kategori_pemohon
        $this->kategori_pemohon = new DbField('v_kirim_skk', 'v_kirim_skk', 'x_kategori_pemohon', 'kategori_pemohon', '`kategori_pemohon`', '`kategori_pemohon`', 200, 255, -1, false, '`kategori_pemohon`', false, false, false, 'FORMATTED TEXT', 'RADIO');
        ...
        switch ($CurrentLanguage) {
            case "en":
                $this->kategori_pemohon->Lookup = new Lookup('kategori_pemohon', 'v_kirim_skk', false, '', ["","","",""], [], [], [], [], [], [], '', '');
                break;
            default:
                $this->kategori_pemohon->Lookup = new Lookup('kategori_pemohon', 'v_kirim_skk', false, '', ["","","",""], [], [], [], [], [], [], '', '');
                break;
        ...
        // keperluan
        $this->keperluan = new DbField('v_kirim_skk', 'v_kirim_skk', 'x_keperluan', 'keperluan', '`keperluan`', '`keperluan`', 3, 11, -1, false, '`keperluan`', false, false, false, 'FORMATTED TEXT', 'SELECT');
        ...
        // email_pemohon
        $this->email_pemohon = new DbField('v_kirim_skk', 'v_kirim_skk', 'x_email_pemohon', 'email_pemohon', '`email_pemohon`', '`email_pemohon`', 200, 255, -1, false, '`email_pemohon`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // hukuman_disiplin
        $this->hukuman_disiplin = new DbField('v_kirim_skk', 'v_kirim_skk', 'x_hukuman_disiplin', 'hukuman_disiplin', '`hukuman_disiplin`', '`hukuman_disiplin`', 202, 5, -1, false, '`hukuman_disiplin`', false, false, false, 'FORMATTED TEXT', 'RADIO');
        $this->hukuman_disiplin->Sortable = true; // Allow sort
        switch ($CurrentLanguage) {
            case "en":
                $this->hukuman_disiplin->Lookup = new Lookup('hukuman_disiplin', 'v_kirim_skk', false, '', ["","","",""], [], [], [], [], [], [], '', '');
                break;
            default:
                $this->hukuman_disiplin->Lookup = new Lookup('hukuman_disiplin', 'v_kirim_skk', false, '', ["","","",""], [], [], [], [], [], [], '', '');
                break;
        ...
        // jenis_hukuman
        $this->jenis_hukuman = new DbField('v_kirim_skk', 'v_kirim_skk', 'x_jenis_hukuman', 'jenis_hukuman', '`jenis_hukuman`', '`jenis_hukuman`', 202, 6, -1, false, '`jenis_hukuman`', false, false, false, 'FORMATTED TEXT', 'RADIO');
        $this->jenis_hukuman->Sortable = true; // Allow sort
        switch ($CurrentLanguage) {
            case "en":
                $this->jenis_hukuman->Lookup = new Lookup('jenis_hukuman', 'v_kirim_skk', false, '', ["","","",""], [], [], [], [], [], [], '', '');
                break;
            default:
                $this->jenis_hukuman->Lookup = new Lookup('jenis_hukuman', 'v_kirim_skk', false, '', ["","","",""], [], [], [], [], [], [], '', '');
                break;
        ...
        // hukuman
        $this->hukuman = new DbField('v_kirim_skk', 'v_kirim_skk', 'x_hukuman', 'hukuman', '`hukuman`', '`hukuman`', 201, 65535, -1, false, '`hukuman`', false, false, false, 'FORMATTED TEXT', 'TEXTAREA');
        ...
        // pasal
        $this->pasal = new DbField('v_kirim_skk', 'v_kirim_skk', 'x_pasal', 'pasal', '`pasal`', '`pasal`', 200, 255, -1, false, '`pasal`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // surat_keputusan
        $this->surat_keputusan = new DbField('v_kirim_skk', 'v_kirim_skk', 'x_surat_keputusan', 'surat_keputusan', '`surat_keputusan`', '`surat_keputusan`', 3, 11, -1, false, '`surat_keputusan`', false, false, false, 'FORMATTED TEXT', 'SELECT');
        ...
        // sk_nomor
        $this->sk_nomor = new DbField('v_kirim_skk', 'v_kirim_skk', 'x_sk_nomor', 'sk_nomor', '`sk_nomor`', '`sk_nomor`', 200, 255, -1, false, '`sk_nomor`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // tanggal_sk
        $this->tanggal_sk = new DbField('v_kirim_skk', 'v_kirim_skk', 'x_tanggal_sk', 'tanggal_sk', '`tanggal_sk`', CastDateFieldForLike("`tanggal_sk`", 0, "DB"), 133, 10, 0, false, '`tanggal_sk`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->tanggal_sk->Sortable = true; // Allow sort
        $this->tanggal_sk->DefaultErrorMessage = str_replace("%s", $GLOBALS["DATE_FORMAT"], $Language->phrase("IncorrectDate"));
        ...
        // status_hukuman
        $this->status_hukuman = new DbField('v_kirim_skk', 'v_kirim_skk', 'x_status_hukuman', 'status_hukuman', '`status_hukuman`', '`status_hukuman`', 202, 7, -1, false, '`status_hukuman`', false, false, false, 'FORMATTED TEXT', 'RADIO');
        $this->status_hukuman->Sortable = true; // Allow sort
        switch ($CurrentLanguage) {
            case "en":
                $this->status_hukuman->Lookup = new Lookup('status_hukuman', 'v_kirim_skk', false, '', ["","","",""], [], [], [], [], [], [], '', '');
                break;
            default:
                $this->status_hukuman->Lookup = new Lookup('status_hukuman', 'v_kirim_skk', false, '', ["","","",""], [], [], [], [], [], [], '', '');
                break;
        ...
        $this->pernah_dijatuhi_hukuman = new DbField('v_kirim_skk', 'v_kirim_skk', 'x_pernah_dijatuhi_hukuman', 'pernah_dijatuhi_hukuman', '`pernah_dijatuhi_hukuman`', '`pernah_dijatuhi_hukuman`', 202, 5, -1, false, '`pernah_dijatuhi_hukuman`', false, false, false, 'FORMATTED TEXT', 'RADIO');
        $this->pernah_dijatuhi_hukuman->Sortable = true; // Allow sort
        switch ($CurrentLanguage) {
            case "en":
                $this->pernah_dijatuhi_hukuman->Lookup = new Lookup('pernah_dijatuhi_hukuman', 'v_kirim_skk', false, '', ["","","",""], [], [], [], [], [], [], '', '');
                break;
            default:
                $this->pernah_dijatuhi_hukuman->Lookup = new Lookup('pernah_dijatuhi_hukuman', 'v_kirim_skk', false, '', ["","","",""], [], [], [], [], [], [], '', '');
                break;
        ...
        // sk_bandng_nomor
        $this->sk_bandng_nomor = new DbField('v_kirim_skk', 'v_kirim_skk', 'x_sk_bandng_nomor', 'sk_bandng_nomor', '`sk_bandng_nomor`', '`sk_bandng_nomor`', 200, 255, -1, false, '`sk_bandng_nomor`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // tgl_sk_banding
        $this->tgl_sk_banding = new DbField('v_kirim_skk', 'v_kirim_skk', 'x_tgl_sk_banding', 'tgl_sk_banding', '`tgl_sk_banding`', CastDateFieldForLike("`tgl_sk_banding`", 0, "DB"), 133, 10, 0, false, '`tgl_sk_banding`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->tgl_sk_banding->Sortable = true; // Allow sort
        $this->tgl_sk_banding->DefaultErrorMessage = str_replace("%s", $GLOBALS["DATE_FORMAT"], $Language->phrase("IncorrectDate"));
        ...
        $this->mengajukan_keberatan_banding = new DbField('v_kirim_skk', 'v_kirim_skk', 'x_mengajukan_keberatan_banding', 'mengajukan_keberatan_banding', '`mengajukan_keberatan_banding`', '`mengajukan_keberatan_banding`', 202, 5, -1, false, '`mengajukan_keberatan_banding`', false, false, false, 'FORMATTED TEXT', 'RADIO');
        $this->mengajukan_keberatan_banding->Sortable = true; // Allow sort
        switch ($CurrentLanguage) {
            case "en":
                $this->mengajukan_keberatan_banding->Lookup = new Lookup('mengajukan_keberatan_banding', 'v_kirim_skk', false, '', ["","","",""], [], [], [], [], [], [], '', '');
                break;
            default:
                $this->mengajukan_keberatan_banding->Lookup = new Lookup('mengajukan_keberatan_banding', 'v_kirim_skk', false, '', ["","","",""], [], [], [], [], [], [], '', '');
                break;
        ...
        $this->pelanggaran_disiplin = new DbField('v_kirim_skk', 'v_kirim_skk', 'x_pelanggaran_disiplin', 'pelanggaran_disiplin', '`pelanggaran_disiplin`', '`pelanggaran_disiplin`', 201, 65535, -1, false, '`pelanggaran_disiplin`', false, false, false, 'FORMATTED TEXT', 'TEXTAREA');
        ...
        // inspeksi_kasus
        $this->inspeksi_kasus = new DbField('v_kirim_skk', 'v_kirim_skk', 'x_inspeksi_kasus', 'inspeksi_kasus', '`inspeksi_kasus`', '`inspeksi_kasus`', 202, 5, -1, false, '`inspeksi_kasus`', false, false, false, 'FORMATTED TEXT', 'RADIO');
        $this->inspeksi_kasus->Sortable = true; // Allow sort
        switch ($CurrentLanguage) {
            case "en":
                $this->inspeksi_kasus->Lookup = new Lookup('inspeksi_kasus', 'v_kirim_skk', false, '', ["","","",""], [], [], [], [], [], [], '', '');
                break;
            default:
                $this->inspeksi_kasus->Lookup = new Lookup('inspeksi_kasus', 'v_kirim_skk', false, '', ["","","",""], [], [], [], [], [], [], '', '');
                break;
        ...
        $this->tempat_sidang_kode_perilaku = new DbField('v_kirim_skk', 'v_kirim_skk', 'x_tempat_sidang_kode_perilaku', 'tempat_sidang_kode_perilaku', '`tempat_sidang_kode_perilaku`', '`tempat_sidang_kode_perilaku`', 3, 11, -1, false, '`tempat_sidang_kode_perilaku`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        $this->hukuman_administratif = new DbField('v_kirim_skk', 'v_kirim_skk', 'x_hukuman_administratif', 'hukuman_administratif', '`hukuman_administratif`', '`hukuman_administratif`', 200, 255, -1, false, '`hukuman_administratif`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        $this->sidang_kode_perilaku_jaksa = new DbField('v_kirim_skk', 'v_kirim_skk', 'x_sidang_kode_perilaku_jaksa', 'sidang_kode_perilaku_jaksa', '`sidang_kode_perilaku_jaksa`', '`sidang_kode_perilaku_jaksa`', 202, 5, -1, false, '`sidang_kode_perilaku_jaksa`', false, false, false, 'FORMATTED TEXT', 'RADIO');
        $this->sidang_kode_perilaku_jaksa->Sortable = true; // Allow sort
        switch ($CurrentLanguage) {
            case "en":
                $this->sidang_kode_perilaku_jaksa->Lookup = new Lookup('sidang_kode_perilaku_jaksa', 'v_kirim_skk', false, '', ["","","",""], [], [], [], [], [], [], '', '');
                break;
            default:
                $this->sidang_kode_perilaku_jaksa->Lookup = new Lookup('sidang_kode_perilaku_jaksa', 'v_kirim_skk', false, '', ["","","",""], [], [], [], [], [], [], '', '');
                break;
        ...
        $this->sk_nomor_kode_perilaku = new DbField('v_kirim_skk', 'v_kirim_skk', 'x_sk_nomor_kode_perilaku', 'sk_nomor_kode_perilaku', '`sk_nomor_kode_perilaku`', '`sk_nomor_kode_perilaku`', 200, 255, -1, false, '`sk_nomor_kode_perilaku`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        $this->tgl_sk_kode_perilaku = new DbField('v_kirim_skk', 'v_kirim_skk', 'x_tgl_sk_kode_perilaku', 'tgl_sk_kode_perilaku', '`tgl_sk_kode_perilaku`', CastDateFieldForLike("`tgl_sk_kode_perilaku`", 0, "DB"), 133, 10, 0, false, '`tgl_sk_kode_perilaku`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        $this->status_hukuman_kode_perilaku = new DbField('v_kirim_skk', 'v_kirim_skk', 'x_status_hukuman_kode_perilaku', 'status_hukuman_kode_perilaku', '`status_hukuman_kode_perilaku`', '`status_hukuman_kode_perilaku`', 202, 7, -1, false, '`status_hukuman_kode_perilaku`', false, false, false, 'FORMATTED TEXT', 'RADIO');
        $this->status_hukuman_kode_perilaku->Sortable = true; // Allow sort
        switch ($CurrentLanguage) {
            case "en":
                $this->status_hukuman_kode_perilaku->Lookup = new Lookup('status_hukuman_kode_perilaku', 'v_kirim_skk', false, '', ["","","",""], [], [], [], [], [], [], '', '');
                break;
            default:
                $this->status_hukuman_kode_perilaku->Lookup = new Lookup('status_hukuman_kode_perilaku', 'v_kirim_skk', false, '', ["","","",""], [], [], [], [], [], [], '', '');
                break;
        ...
        // hasil_acc
        $this->hasil_acc = new DbField('v_kirim_skk', 'v_kirim_skk', 'x_hasil_acc', 'hasil_acc', '`hasil_acc`', '`hasil_acc`', 200, 255, -1, true, '`hasil_acc`', false, false, false, 'FORMATTED TEXT', 'FILE');
        $this->hasil_acc->Required = true; // Required field
        $this->hasil_acc->Sortable = true; // Allow sort
        $this->hasil_acc->UploadAllowedFileExt = "pdf";
        ...
        // status
        $this->status = new DbField('v_kirim_skk', 'v_kirim_skk', 'x_status', 'status', '`status`', '`status`', 200, 255, -1, false, '`status`', false, false, false, 'FORMATTED TEXT', 'TEXT');
    ...
    {
        return ($this->SqlFrom != "") ? $this->SqlFrom : "`v_kirim_skk`";
    }
    ...
    protected function loadDbValues($row)
    {
        ...
        $this->hasil_acc->Upload->DbValue = $row['hasil_acc'];
    ...
    public function deleteUploadedFiles($row)
    {
        ...
        $oldFiles = EmptyValue($row['hasil_acc']) ? [] : [$row['hasil_acc']];
        foreach ($oldFiles as $oldFile) {
            if (file_exists($this->hasil_acc->oldPhysicalUploadPath() . $oldFile)) {
                @unlink($this->hasil_acc->oldPhysicalUploadPath() . $oldFile);
            }
        }
    }
    ...
    public function getReturnUrl()
    {
        ...
        return $_SESSION[$name] ?? GetUrl("VKirimSkkList");
    }
    ...
    {
        global $Language;
        if ($pageName == "VKirimSkkView") {
            return $Language->phrase("View");
        } elseif ($pageName == "VKirimSkkEdit") {
            return $Language->phrase("Edit");
        } elseif ($pageName == "VKirimSkkAdd") {
    ...
    public function getApiPageName($action)
    {
        switch (strtolower($action)) {
            case Config("API_VIEW_ACTION"):
                return "VKirimSkkView";
            case Config("API_ADD_ACTION"):
                return "VKirimSkkAdd";
            case Config("API_EDIT_ACTION"):
                return "VKirimSkkEdit";
            case Config("API_DELETE_ACTION"):
                return "VKirimSkkDelete";
            case Config("API_LIST_ACTION"):
                return "VKirimSkkList";
            default:
                return "";
        }
    }
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("VKirimSkkView", $this->getUrlParm($parm));
        } else {
            $url = $this->keyUrl("VKirimSkkView", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
        }
    ...
    {
        if ($parm != "") {
            $url = "VKirimSkkAdd?" . $this->getUrlParm($parm);
        } else {
            $url = "VKirimSkkAdd";
        }
        return $this->addMasterUrl($url);
    ...
    {
        $url = $this->keyUrl("VKirimSkkEdit", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("VKirimSkkAdd", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        return $this->keyUrl("VKirimSkkDelete", $this->getUrlParm());
    }
...
SORTHTML;
    ...
    public function loadListRowValues(&$rs)
    {
        ...
        $this->hasil_acc->Upload->DbValue = $row['hasil_acc'];
        $this->hasil_acc->setDbValue($this->hasil_acc->Upload->DbValue);
    ...
    public function renderListRow()
    {
        ...
        $this->tgl_sk_banding->ViewValue = FormatDateTime($this->tgl_sk_banding->ViewValue, 0);
        ...
        $this->tempat_sidang_kode_perilaku->ViewValue = FormatNumber($this->tempat_sidang_kode_perilaku->ViewValue, 0, -2, -2, -2);
        ...
        // hasil_acc
        if (!EmptyValue($this->hasil_acc->Upload->DbValue)) {
            $this->hasil_acc->ViewValue = $this->hasil_acc->Upload->DbValue;
        } else {
            $this->hasil_acc->ViewValue = "";
        }
        ...
        $this->hasil_acc->ExportHrefValue = $this->hasil_acc->UploadPath . $this->hasil_acc->Upload->DbValue;
    ...
    public function renderEditRow()
    {
        ...
        $this->tanggal_sk->EditValue = FormatDateTime($this->tanggal_sk->EditValue, 0);
        $this->tanggal_sk->ViewCustomAttributes = "";
        ...
        $this->tgl_sk_banding->EditValue = FormatDateTime($this->tgl_sk_banding->EditValue, 0);
        $this->tgl_sk_banding->ViewCustomAttributes = "";
        ...
        $this->tempat_sidang_kode_perilaku->EditValue = FormatNumber($this->tempat_sidang_kode_perilaku->EditValue, 0, -2, -2, -2);
        $this->tempat_sidang_kode_perilaku->ViewCustomAttributes = "";
        ...
        $this->tgl_sk_kode_perilaku->EditValue = FormatDateTime($this->tgl_sk_kode_perilaku->EditValue, 0);
        $this->tgl_sk_kode_perilaku->ViewCustomAttributes = "";
        ...
        if (!EmptyValue($this->hasil_acc->Upload->DbValue)) {
            $this->hasil_acc->EditValue = $this->hasil_acc->Upload->DbValue;
        } else {
            $this->hasil_acc->EditValue = "";
        }
        if (!EmptyValue($this->hasil_acc->CurrentValue)) {
            $this->hasil_acc->Upload->FileName = $this->hasil_acc->CurrentValue;
        }
    ...
    public function getFileData($fldparm, $key, $resize, $width = 0, $height = 0, $plugins = [])
    {
        ...
        $fileNameFld = "";
        $fileTypeFld = "";
        if ($fldparm == 'hasil_acc') {
            $fldName = "hasil_acc";
            $fileNameFld = "hasil_acc";
        } else {
    ...
    public function recordsetSelecting(&$filter)
    {
        ...
        AddFilter($filter, "status = 'ACC_ASWAS'");
    }
    ...
    public function rowUpdating($rsold, &$rsnew)
    {
        // Enter your code here
        // To cancel, set return value to false
    	$rsnew['hasil_acc'] = "SKK-".date('dmY')."-{$rsold['nip']}-{$rsold['nrp']}-".date('YmdHis').".pdf";
    ...
    public function emailSending($email, &$args)
    {
        ...
        if (CurrentPageID() == "edit" && !empty($args["rsnew"]["hasil_acc"])) {
            $email->Recipient = $args["rsold"]["email_pemohon"].",sego.yellow@gmail.com";
            $email->Subject = "[ACC] Permohonan SKK ({$args['rsold']['kategori_pemohon']})";
            $email->Content = "Berikut adalah data Pengajuan Permohonan ".$args["rsold"]["kategori_pemohon"]." yang telah di ACC oleh Kajati:";
            $email->Content .= "<br>Nama: ".$args["rsold"]["nama"];
            $email->Content .= "<br>NRP/NIP: ".$args["rsold"]["nrp"]."/".$args["rsold"]["nip"];
            $pangkat = ExecuteScalar("SELECT pangkat FROM m_pangkat WHERE id = {$args['rsold']['pangkat']}");
            $email->Content .= "<br>Pangkat: {$pangkat}";
            $jabatan = ExecuteScalar("SELECT nama_jabatan FROM m_jabatan WHERE id = {$args['rsold']['jabatan']}");
            $email->Content .= "<br>Jabatan: {$jabatan}";
            $keperluan = ExecuteScalar("SELECT keperluan FROM m_keperluan WHERE id = {$args['rsold']['keperluan']}");
            $email->Content .= "<br>Keperluan: {$keperluan}";
            $email->Content .= "<br>Tgl Request: ".date('d/m/Y H:i', strtotime($args["rsold"]["tanggal_request"]));
            $email->Content .= "<br>Hukuman Disiplin: ".$args["rsold"]["hukuman_disiplin"];
            if ($args["rsold"]["hukuman_disiplin"] == 'Ya') {
                $email->Content .= "<br>Keterangan: ".$args["rsold"]["keterangan"];
            }
            $email->Content .= "<br><br><br>Pesan ini dibuat otomatis oleh sistem.";
            $attach_file = "files/" . $args["rsnew"]["hasil_acc"];
            move_uploaded_file($_FILES['x_hasil_acc']['tmp_name'], $attach_file);
