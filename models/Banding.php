...
/**
 * Table class for banding
 */
class Banding extends DbTable
{
    protected $SqlFrom = "";
    ...
    public function __construct()
    {
        ...
        $this->TableVar = 'banding';
        $this->TableName = 'banding';
        $this->TableType = 'TABLE';

        // Update Table
        $this->UpdateTable = "`banding`";
        $this->Dbid = 'DB';
        $this->ExportAll = true;
        ...
        // id
        $this->id = new DbField('banding', 'banding', 'x_id', 'id', '`id`', '`id`', 3, 11, -1, false, '`id`', false, false, false, 'FORMATTED TEXT', 'NO');
        ...
        // pid_request_skk
        $this->pid_request_skk = new DbField('banding', 'banding', 'x_pid_request_skk', 'pid_request_skk', '`pid_request_skk`', '`pid_request_skk`', 20, 20, -1, false, '`pid_request_skk`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        $this->mengajukan_keberatan_banding = new DbField('banding', 'banding', 'x_mengajukan_keberatan_banding', 'mengajukan_keberatan_banding', '`mengajukan_keberatan_banding`', '`mengajukan_keberatan_banding`', 202, 5, -1, false, '`mengajukan_keberatan_banding`', false, false, false, 'FORMATTED TEXT', 'RADIO');
        $this->mengajukan_keberatan_banding->Required = true; // Required field
        $this->mengajukan_keberatan_banding->Sortable = true; // Allow sort
        switch ($CurrentLanguage) {
            case "en":
                $this->mengajukan_keberatan_banding->Lookup = new Lookup('mengajukan_keberatan_banding', 'banding', false, '', ["","","",""], [], [], [], [], [], [], '', '');
                break;
            default:
                $this->mengajukan_keberatan_banding->Lookup = new Lookup('mengajukan_keberatan_banding', 'banding', false, '', ["","","",""], [], [], [], [], [], [], '', '');
                break;
        ...
        // sk_banding_nomor
        $this->sk_banding_nomor = new DbField('banding', 'banding', 'x_sk_banding_nomor', 'sk_banding_nomor', '`sk_banding_nomor`', '`sk_banding_nomor`', 200, 255, -1, false, '`sk_banding_nomor`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // tgl_sk_banding
        $this->tgl_sk_banding = new DbField('banding', 'banding', 'x_tgl_sk_banding', 'tgl_sk_banding', '`tgl_sk_banding`', CastDateFieldForLike("`tgl_sk_banding`", 0, "DB"), 133, 10, 0, false, '`tgl_sk_banding`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        $this->tgl_sk_banding->AdvancedSearch->SearchValueDefault = 'Tidak';
        $this->tgl_sk_banding->AdvancedSearch->SearchOperatorDefault = "=";
        $this->tgl_sk_banding->AdvancedSearch->SearchOperatorDefault2 = "";
        $this->tgl_sk_banding->AdvancedSearch->SearchConditionDefault = "AND";
    ...
    {
        return ($this->SqlFrom != "") ? $this->SqlFrom : "`banding`";
    }
    ...
    public function getReturnUrl()
    {
        ...
        return $_SESSION[$name] ?? GetUrl("BandingList");
    }
    ...
    {
        global $Language;
        if ($pageName == "BandingView") {
            return $Language->phrase("View");
        } elseif ($pageName == "BandingEdit") {
            return $Language->phrase("Edit");
        } elseif ($pageName == "BandingAdd") {
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("BandingView", $this->getUrlParm($parm));
        } else {
            $url = $this->keyUrl("BandingView", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
        }
    ...
    {
        if ($parm != "") {
            $url = "BandingAdd?" . $this->getUrlParm($parm);
        } else {
            $url = "BandingAdd";
        }
        return $this->addMasterUrl($url);
    ...
    {
        $url = $this->keyUrl("BandingEdit", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("BandingAdd", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        return $this->keyUrl("BandingDelete", $this->getUrlParm());
    }
...
SORTHTML;
    ...
    public function renderEditRow()
    {
        ...
        $this->tgl_sk_banding->EditValue = FormatDateTime($this->tgl_sk_banding->CurrentValue, 8);
