 ...
 * Page class
 */
class MPangkatEdit extends MPangkat
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "MPangkatEdit";
    ...
    protected function editRow()
    {
        ...
        if (!$rsold) {
            ...
            // pangkat
            $this->pangkat->setDbValueDef($rsnew, $this->pangkat->CurrentValue, null, $this->pangkat->ReadOnly);
