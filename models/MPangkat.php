...
/**
 * Table class for m_pangkat
 */
class MPangkat extends DbTable
{
    protected $SqlFrom = "";
    ...
    public function __construct()
    {
        ...
        $this->TableVar = 'm_pangkat';
        $this->TableName = 'm_pangkat';
        $this->TableType = 'TABLE';

        // Update Table
        $this->UpdateTable = "`m_pangkat`";
        $this->Dbid = 'DB';
        $this->ExportAll = true;
    ...
    {
        return ($this->SqlFrom != "") ? $this->SqlFrom : "`m_pangkat`";
    }
    ...
    public function getReturnUrl()
    {
        ...
        return $_SESSION[$name] ?? GetUrl("MPangkatList");
    }
    ...
    {
        global $Language;
        if ($pageName == "MPangkatView") {
            return $Language->phrase("View");
        } elseif ($pageName == "MPangkatEdit") {
            return $Language->phrase("Edit");
        } elseif ($pageName == "MPangkatAdd") {
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("MPangkatView", $this->getUrlParm($parm));
        } else {
            $url = $this->keyUrl("MPangkatView", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
        }
    ...
    {
        if ($parm != "") {
            $url = "MPangkatAdd?" . $this->getUrlParm($parm);
        } else {
            $url = "MPangkatAdd";
        }
        return $this->addMasterUrl($url);
    ...
    {
        $url = $this->keyUrl("MPangkatEdit", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("MPangkatAdd", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        return $this->keyUrl("MPangkatDelete", $this->getUrlParm());
    }
...
SORTHTML;
    ...
    public function renderEditRow()
    {
        ...
        if (!$this->pangkat->Raw) {
            $this->pangkat->CurrentValue = HtmlDecode($this->pangkat->CurrentValue);
        }
