 ...
 * Page class
 */
class MPangkatAdd extends MPangkat
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "MPangkatAdd";
        ...
        switch ($this->CurrentAction) {
            case "copy": // Copy an existing record
                if (!$loaded) { // Record not loaded
                    ...
                    $this->terminate("MPangkatList"); // No matching record, return to list
                    return;
                }
                break;
            case "insert": // Add new record
                ...
                if ($this->addRow($this->OldRecordset)) { // Add successful
                    ...
                    if (GetPageName($returnUrl) == "MPangkatList") {
                        $returnUrl = $this->addMasterUrl($returnUrl); // List page, return to List page with correct master key if necessary
                    } elseif (GetPageName($returnUrl) == "MPangkatView") {
    ...
    protected function addRow($rsold = null)
    {
        ...
        // pangkat
        $this->pangkat->setDbValueDef($rsnew, $this->pangkat->CurrentValue, null, false);
    ...
    protected function setupBreadcrumb()
    {
        ...
        $url = CurrentUrl();
        $Breadcrumb->add("list", $this->TableVar, $this->addMasterUrl("MPangkatList"), "", $this->TableVar, true);
