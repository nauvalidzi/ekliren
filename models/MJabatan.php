 ...
 */
class MJabatan extends DbTable
{
    protected $SqlFrom = "";
    ...
    public function getReturnUrl()
    {
        ...
        return $_SESSION[$name] ?? GetUrl("MJabatanList");
    }
    ...
    {
        global $Language;
        if ($pageName == "MJabatanView") {
            return $Language->phrase("View");
        } elseif ($pageName == "MJabatanEdit") {
            return $Language->phrase("Edit");
        } elseif ($pageName == "MJabatanAdd") {
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("MJabatanView", $this->getUrlParm($parm));
        } else {
            $url = $this->keyUrl("MJabatanView", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
        }
    ...
    {
        if ($parm != "") {
            $url = "MJabatanAdd?" . $this->getUrlParm($parm);
        } else {
            $url = "MJabatanAdd";
        }
        return $this->addMasterUrl($url);
    ...
    {
        $url = $this->keyUrl("MJabatanEdit", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("MJabatanAdd", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        return $this->keyUrl("MJabatanDelete", $this->getUrlParm());
    }
