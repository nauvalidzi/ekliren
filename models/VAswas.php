...
class VAswas extends DbTable
{
    ...
    public function __construct()
    {
        ...
        // keterangan
        $this->keterangan = new DbField('v_aswas', 'v_aswas', 'x_keterangan', 'keterangan', '`keterangan`', '`keterangan`', 200, 255, -1, false, '`keterangan`', false, false, false, 'FORMATTED TEXT', 'TEXTAREA');
