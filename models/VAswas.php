...
/**
 * Table class for v_aswas
 */
class VAswas extends DbTable
{
    protected $SqlFrom = "";
    ...
    public function __construct()
    {
        ...
        $this->TableVar = 'v_aswas';
        $this->TableName = 'v_aswas';
        $this->TableType = 'VIEW';

        // Update Table
        $this->UpdateTable = "`v_aswas`";
        $this->Dbid = 'DB';
        $this->ExportAll = true;
        ...
        // id_request
        $this->id_request = new DbField('v_aswas', 'v_aswas', 'x_id_request', 'id_request', '`id_request`', '`id_request`', 20, 20, -1, false, '`id_request`', false, false, false, 'FORMATTED TEXT', 'NO');
        ...
        // tanggal_request
        $this->tanggal_request = new DbField('v_aswas', 'v_aswas', 'x_tanggal_request', 'tanggal_request', '`tanggal_request`', CastDateFieldForLike("`tanggal_request`", 117, "DB"), 135, 19, 117, false, '`tanggal_request`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // nip
        $this->nip = new DbField('v_aswas', 'v_aswas', 'x_nip', 'nip', '`nip`', '`nip`', 200, 255, -1, false, '`nip`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // nrp
        $this->nrp = new DbField('v_aswas', 'v_aswas', 'x_nrp', 'nrp', '`nrp`', '`nrp`', 200, 255, -1, false, '`nrp`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // nama
        $this->nama = new DbField('v_aswas', 'v_aswas', 'x_nama', 'nama', '`nama`', '`nama`', 200, 255, -1, false, '`nama`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // jabatan
        $this->jabatan = new DbField('v_aswas', 'v_aswas', 'x_jabatan', 'jabatan', '`jabatan`', '`jabatan`', 3, 11, -1, false, '`jabatan`', false, false, false, 'FORMATTED TEXT', 'SELECT');
        ...
        switch ($CurrentLanguage) {
            case "en":
                $this->kategori_pemohon->Lookup = new Lookup('kategori_pemohon', 'v_aswas', false, '', ["","","",""], [], [], [], [], [], [], '', '');
                break;
            default:
                $this->kategori_pemohon->Lookup = new Lookup('kategori_pemohon', 'v_aswas', false, '', ["","","",""], [], [], [], [], [], [], '', '');
                break;
        ...
        // email_pemohon
        $this->email_pemohon = new DbField('v_aswas', 'v_aswas', 'x_email_pemohon', 'email_pemohon', '`email_pemohon`', '`email_pemohon`', 200, 255, -1, false, '`email_pemohon`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // hukuman_disiplin
        $this->hukuman_disiplin = new DbField('v_aswas', 'v_aswas', 'x_hukuman_disiplin', 'hukuman_disiplin', '`hukuman_disiplin`', '`hukuman_disiplin`', 202, 5, -1, false, '`hukuman_disiplin`', false, false, false, 'FORMATTED TEXT', 'RADIO');
        $this->hukuman_disiplin->Sortable = true; // Allow sort
        switch ($CurrentLanguage) {
            case "en":
                $this->hukuman_disiplin->Lookup = new Lookup('hukuman_disiplin', 'v_aswas', false, '', ["","","",""], [], [], [], [], [], [], '', '');
                break;
            default:
                $this->hukuman_disiplin->Lookup = new Lookup('hukuman_disiplin', 'v_aswas', false, '', ["","","",""], [], [], [], [], [], [], '', '');
                break;
        ...
        // keterangan
        $this->keterangan = new DbField('v_aswas', 'v_aswas', 'x_keterangan', 'keterangan', '`keterangan`', '`keterangan`', 201, 65535, -1, false, '`keterangan`', false, false, false, 'FORMATTED TEXT', 'TEXTAREA');
        ...
        // status
        $this->status = new DbField('v_aswas', 'v_aswas', 'x_status', 'status', '`status`', '`status`', 200, 255, -1, false, '`status`', false, false, false, 'FORMATTED TEXT', 'RADIO');
        $this->status->Required = true; // Required field
        $this->status->Sortable = true; // Allow sort
        switch ($CurrentLanguage) {
            case "en":
                $this->status->Lookup = new Lookup('status', 'v_aswas', false, '', ["","","",""], [], [], [], [], [], [], '', '');
                break;
            default:
                $this->status->Lookup = new Lookup('status', 'v_aswas', false, '', ["","","",""], [], [], [], [], [], [], '', '');
                break;
        ...
        $this->pernah_dijatuhi_hukuman = new DbField('v_aswas', 'v_aswas', 'x_pernah_dijatuhi_hukuman', 'pernah_dijatuhi_hukuman', '`pernah_dijatuhi_hukuman`', '`pernah_dijatuhi_hukuman`', 202, 5, -1, false, '`pernah_dijatuhi_hukuman`', false, false, false, 'FORMATTED TEXT', 'RADIO');
        $this->pernah_dijatuhi_hukuman->Sortable = true; // Allow sort
        switch ($CurrentLanguage) {
            case "en":
                $this->pernah_dijatuhi_hukuman->Lookup = new Lookup('pernah_dijatuhi_hukuman', 'v_aswas', false, '', ["","","",""], [], [], [], [], [], [], '', '');
                break;
            default:
                $this->pernah_dijatuhi_hukuman->Lookup = new Lookup('pernah_dijatuhi_hukuman', 'v_aswas', false, '', ["","","",""], [], [], [], [], [], [], '', '');
                break;
        ...
        // jenis_hukuman
        $this->jenis_hukuman = new DbField('v_aswas', 'v_aswas', 'x_jenis_hukuman', 'jenis_hukuman', '`jenis_hukuman`', '`jenis_hukuman`', 202, 6, -1, false, '`jenis_hukuman`', false, false, false, 'FORMATTED TEXT', 'RADIO');
        $this->jenis_hukuman->Sortable = true; // Allow sort
        switch ($CurrentLanguage) {
            case "en":
                $this->jenis_hukuman->Lookup = new Lookup('jenis_hukuman', 'v_aswas', false, '', ["","","",""], [], [], [], [], [], [], '', '');
                break;
            default:
                $this->jenis_hukuman->Lookup = new Lookup('jenis_hukuman', 'v_aswas', false, '', ["","","",""], [], [], [], [], [], [], '', '');
                break;
        ...
        // hukuman
        $this->hukuman = new DbField('v_aswas', 'v_aswas', 'x_hukuman', 'hukuman', '`hukuman`', '`hukuman`', 201, 65535, -1, false, '`hukuman`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // pasal
        $this->pasal = new DbField('v_aswas', 'v_aswas', 'x_pasal', 'pasal', '`pasal`', '`pasal`', 200, 255, -1, false, '`pasal`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // surat_keputusan
        $this->surat_keputusan = new DbField('v_aswas', 'v_aswas', 'x_surat_keputusan', 'surat_keputusan', '`surat_keputusan`', '`surat_keputusan`', 3, 11, -1, false, '`surat_keputusan`', false, false, false, 'FORMATTED TEXT', 'SELECT');
        ...
        // sk_nomor
        $this->sk_nomor = new DbField('v_aswas', 'v_aswas', 'x_sk_nomor', 'sk_nomor', '`sk_nomor`', '`sk_nomor`', 200, 255, -1, false, '`sk_nomor`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // tanggal_sk
        $this->tanggal_sk = new DbField('v_aswas', 'v_aswas', 'x_tanggal_sk', 'tanggal_sk', '`tanggal_sk`', CastDateFieldForLike("`tanggal_sk`", 7, "DB"), 133, 10, 7, false, '`tanggal_sk`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // status_hukuman
        $this->status_hukuman = new DbField('v_aswas', 'v_aswas', 'x_status_hukuman', 'status_hukuman', '`status_hukuman`', '`status_hukuman`', 202, 7, -1, false, '`status_hukuman`', false, false, false, 'FORMATTED TEXT', 'RADIO');
        $this->status_hukuman->Sortable = true; // Allow sort
        switch ($CurrentLanguage) {
            case "en":
                $this->status_hukuman->Lookup = new Lookup('status_hukuman', 'v_aswas', false, '', ["","","",""], [], [], [], [], [], [], '', '');
                break;
            default:
                $this->status_hukuman->Lookup = new Lookup('status_hukuman', 'v_aswas', false, '', ["","","",""], [], [], [], [], [], [], '', '');
                break;
        ...
        $this->mengajukan_keberatan_banding = new DbField('v_aswas', 'v_aswas', 'x_mengajukan_keberatan_banding', 'mengajukan_keberatan_banding', '`mengajukan_keberatan_banding`', '`mengajukan_keberatan_banding`', 202, 5, -1, false, '`mengajukan_keberatan_banding`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // tgl_sk_banding
        $this->tgl_sk_banding = new DbField('v_aswas', 'v_aswas', 'x_tgl_sk_banding', 'tgl_sk_banding', '`tgl_sk_banding`', CastDateFieldForLike("`tgl_sk_banding`", 7, "DB"), 133, 10, 7, false, '`tgl_sk_banding`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // inspeksi_kasus
        $this->inspeksi_kasus = new DbField('v_aswas', 'v_aswas', 'x_inspeksi_kasus', 'inspeksi_kasus', '`inspeksi_kasus`', '`inspeksi_kasus`', 202, 5, -1, false, '`inspeksi_kasus`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        $this->pelanggaran_disiplin = new DbField('v_aswas', 'v_aswas', 'x_pelanggaran_disiplin', 'pelanggaran_disiplin', '`pelanggaran_disiplin`', '`pelanggaran_disiplin`', 201, 65535, -1, false, '`pelanggaran_disiplin`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        $this->sidang_kode_perilaku_jaksa = new DbField('v_aswas', 'v_aswas', 'x_sidang_kode_perilaku_jaksa', 'sidang_kode_perilaku_jaksa', '`sidang_kode_perilaku_jaksa`', '`sidang_kode_perilaku_jaksa`', 202, 5, -1, false, '`sidang_kode_perilaku_jaksa`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        $this->tempat_sidang_kode_perilaku = new DbField('v_aswas', 'v_aswas', 'x_tempat_sidang_kode_perilaku', 'tempat_sidang_kode_perilaku', '`tempat_sidang_kode_perilaku`', '`tempat_sidang_kode_perilaku`', 3, 11, -1, false, '`tempat_sidang_kode_perilaku`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        $this->hukuman_administratif = new DbField('v_aswas', 'v_aswas', 'x_hukuman_administratif', 'hukuman_administratif', '`hukuman_administratif`', '`hukuman_administratif`', 200, 255, -1, false, '`hukuman_administratif`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        $this->sk_nomor_kode_perilaku = new DbField('v_aswas', 'v_aswas', 'x_sk_nomor_kode_perilaku', 'sk_nomor_kode_perilaku', '`sk_nomor_kode_perilaku`', '`sk_nomor_kode_perilaku`', 200, 255, -1, false, '`sk_nomor_kode_perilaku`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        $this->tgl_sk_kode_perilaku = new DbField('v_aswas', 'v_aswas', 'x_tgl_sk_kode_perilaku', 'tgl_sk_kode_perilaku', '`tgl_sk_kode_perilaku`', CastDateFieldForLike("`tgl_sk_kode_perilaku`", 7, "DB"), 133, 10, 7, false, '`tgl_sk_kode_perilaku`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        $this->status_hukuman_kode_perilaku = new DbField('v_aswas', 'v_aswas', 'x_status_hukuman_kode_perilaku', 'status_hukuman_kode_perilaku', '`status_hukuman_kode_perilaku`', '`status_hukuman_kode_perilaku`', 202, 7, -1, false, '`status_hukuman_kode_perilaku`', false, false, false, 'FORMATTED TEXT', 'RADIO');
        $this->status_hukuman_kode_perilaku->Sortable = true; // Allow sort
        switch ($CurrentLanguage) {
            case "en":
                $this->status_hukuman_kode_perilaku->Lookup = new Lookup('status_hukuman_kode_perilaku', 'v_aswas', false, '', ["","","",""], [], [], [], [], [], [], '', '');
                break;
            default:
                $this->status_hukuman_kode_perilaku->Lookup = new Lookup('status_hukuman_kode_perilaku', 'v_aswas', false, '', ["","","",""], [], [], [], [], [], [], '', '');
                break;
        ...
        // sk_banding_nomor
        $this->sk_banding_nomor = new DbField('v_aswas', 'v_aswas', 'x_sk_banding_nomor', 'sk_banding_nomor', '`sk_banding_nomor`', '`sk_banding_nomor`', 200, 255, -1, false, '`sk_banding_nomor`', false, false, false, 'FORMATTED TEXT', 'TEXT');
    ...
    {
        return ($this->SqlFrom != "") ? $this->SqlFrom : "`v_aswas`";
    }
    ...
    public function getReturnUrl()
    {
        ...
        return $_SESSION[$name] ?? GetUrl("VAswasList");
    }
    ...
    public function getModalCaption($pageName)
    {
        ...
        } elseif ($pageName == "VAswasEdit") {
            return $Language->phrase("Edit");
        } elseif ($pageName == "VAswasAdd") {
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("VAswasView", $this->getUrlParm($parm));
        } else {
            $url = $this->keyUrl("VAswasView", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
        }
    ...
    {
        if ($parm != "") {
            $url = "VAswasAdd?" . $this->getUrlParm($parm);
        } else {
            $url = "VAswasAdd";
        }
        return $this->addMasterUrl($url);
    ...
    {
        $url = $this->keyUrl("VAswasEdit", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("VAswasAdd", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        return $this->keyUrl("VAswasDelete", $this->getUrlParm());
    }
...
SORTHTML;
    ...
    {
        //Log("Row Updated");
        ExecuteUpdate("INSERT INTO riwayat_acc (id_skk, status, verifikator, tanggal) VALUES ({$rsold['id_request']}, '{$rsnew['status']}', 'aswas', '".date('Y-m-d H:i:s')."')");
    }
