...
class PrintSkk
{
    ...
    // Table name
    public $TableName = 'print_skk.php';

    // Page object name
    public $PageObjName = "PrintSkk";
    ...
    public function __construct()
    {
        ...
        if (!defined(PROJECT_NAMESPACE . "TABLE_NAME")) {
            define(PROJECT_NAMESPACE . "TABLE_NAME", 'print_skk.php');
        }
    ...
    protected function setupBreadcrumb()
    {
        ...
        $Breadcrumb->add("custom", "print_skk", CurrentUrl(), "", "print_skk", true);
        $this->Heading = $Language->TablePhrase("print_skk", "TblCaption");
    }
