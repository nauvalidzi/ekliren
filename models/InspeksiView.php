 ...
 * Page class
 */
class InspeksiView extends Inspeksi
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "InspeksiView";
    ...
    public function run()
    {
        ...
        if ($this->isPageRequest()) { // Validate request
            if (($keyValue = Get("id") ?? Route("id")) !== null) {
                ...
                $returnUrl = "InspeksiList"; // Return to list
            }
            ...
            switch ($this->CurrentAction) {
                case "show": // Get a record to display
                    ...
                    if (!$res) { // Load record based on key
                        ...
                        $returnUrl = "InspeksiList"; // No matching record, return to list
                    }
                    break;
            }
        } else {
            $returnUrl = "InspeksiList"; // Not page request, return to list
        }
        if ($returnUrl != "") {
