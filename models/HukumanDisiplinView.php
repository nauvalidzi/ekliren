 ...
 * Page class
 */
class HukumanDisiplinView extends HukumanDisiplin
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "HukumanDisiplinView";
    ...
    public function run()
    {
        ...
        if ($this->isPageRequest()) { // Validate request
            if (($keyValue = Get("id") ?? Route("id")) !== null) {
                ...
                $returnUrl = "HukumanDisiplinList"; // Return to list
            }
            ...
            switch ($this->CurrentAction) {
                case "show": // Get a record to display
                    ...
                    if (!$res) { // Load record based on key
                        ...
                        $returnUrl = "HukumanDisiplinList"; // No matching record, return to list
                    }
                    break;
            }
        } else {
            $returnUrl = "HukumanDisiplinList"; // Not page request, return to list
        }
        if ($returnUrl != "") {
