...
loadjs.ready("head", function () {
    ...
    fm_pangkatadd = currentForm = new ew.Form("fm_pangkatadd", "add");
    ...
    // Validate form
    fm_pangkatadd.validate = function () {
    ...
    // Form_CustomValidate
    fm_pangkatadd.customValidate = function(fobj) { // DO NOT CHANGE THIS LINE!
        // Your custom validation code here, return false if invalid.
        return true;
    }

    // Use JavaScript validation or not
    fm_pangkatadd.validateRequired = <?= Config("CLIENT_VALIDATE") ? "true" : "false" ?>;

    // Dynamic selection lists
    loadjs.done("fm_pangkatadd");
});
</script>
<script>
loadjs.ready("head", function () {
...
$Page->showMessage();
?>
<form name="fm_pangkatadd" id="fm_pangkatadd" class="<?= $Page->FormClassName ?>" action="<?= CurrentPageUrl(false) ?>" method="post">
