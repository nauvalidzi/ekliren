...
// Page object
$MSatuanKerjaEdit = &$Page;
?>
<script>
var currentForm, currentPageID;
var fm_satuan_kerjaedit;
loadjs.ready("head", function () {
    var $ = jQuery;
    // Form object
    currentPageID = ew.PAGE_ID = "edit";
    fm_satuan_kerjaedit = currentForm = new ew.Form("fm_satuan_kerjaedit", "edit");
    ...
    // Validate form
    fm_satuan_kerjaedit.validate = function () {
    ...
    // Form_CustomValidate
    fm_satuan_kerjaedit.customValidate = function(fobj) { // DO NOT CHANGE THIS LINE!
        // Your custom validation code here, return false if invalid.
        return true;
    }

    // Use JavaScript validation or not
    fm_satuan_kerjaedit.validateRequired = <?= Config("CLIENT_VALIDATE") ? "true" : "false" ?>;

    // Dynamic selection lists
    loadjs.done("fm_satuan_kerjaedit");
});
</script>
<script>
loadjs.ready("head", function () {
...
$Page->showMessage();
?>
<form name="fm_satuan_kerjaedit" id="fm_satuan_kerjaedit" class="<?= $Page->FormClassName ?>" action="<?= CurrentPageUrl(false) ?>" method="post">
