...
// Page object
$MSuratKeputusanDelete = &$Page;
?>
<script>
var currentForm, currentPageID;
var fm_surat_keputusandelete;
loadjs.ready("head", function () {
    var $ = jQuery;
    // Form object
    currentPageID = ew.PAGE_ID = "delete";
    fm_surat_keputusandelete = currentForm = new ew.Form("fm_surat_keputusandelete", "delete");
    loadjs.done("fm_surat_keputusandelete");
});
</script>
<script>
loadjs.ready("head", function () {
...
$Page->showMessage();
?>
<form name="fm_surat_keputusandelete" id="fm_surat_keputusandelete" class="form-inline ew-form ew-delete-form" action="<?= CurrentPageUrl(false) ?>" method="post">
