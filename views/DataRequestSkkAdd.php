...
// Page object
$DataRequestSkkAdd = &$Page;
?>
<script>
var currentForm, currentPageID;
var fdata_request_skkadd;
loadjs.ready("head", function () {
    var $ = jQuery;
    // Form object
    currentPageID = ew.PAGE_ID = "add";
    fdata_request_skkadd = currentForm = new ew.Form("fdata_request_skkadd", "add");
    ...
    fdata_request_skkadd.addFields([
    ...
    // Validate form
    fdata_request_skkadd.validate = function () {
    ...
    // Form_CustomValidate
    fdata_request_skkadd.customValidate = function(fobj) { // DO NOT CHANGE THIS LINE!
        // Your custom validation code here, return false if invalid.
        return true;
    }

    // Use JavaScript validation or not
    fdata_request_skkadd.validateRequired = <?= Config("CLIENT_VALIDATE") ? "true" : "false" ?>;

    // Dynamic selection lists
    fdata_request_skkadd.lists.unit_organisasi = <?= $Page->unit_organisasi->toClientList($Page) ?>;
    fdata_request_skkadd.lists.pangkat = <?= $Page->pangkat->toClientList($Page) ?>;
    fdata_request_skkadd.lists.jabatan = <?= $Page->jabatan->toClientList($Page) ?>;
    fdata_request_skkadd.lists.keperluan = <?= $Page->keperluan->toClientList($Page) ?>;
    fdata_request_skkadd.lists.kategori_pemohon = <?= $Page->kategori_pemohon->toClientList($Page) ?>;
    fdata_request_skkadd.lists.hukuman_disiplin = <?= $Page->hukuman_disiplin->toClientList($Page) ?>;
    loadjs.done("fdata_request_skkadd");
});
</script>
<script>
loadjs.ready("head", function () {
...
$Page->showMessage();
?>
<form name="fdata_request_skkadd" id="fdata_request_skkadd" class="<?= $Page->FormClassName ?>" action="<?= CurrentPageUrl(false) ?>" method="post">
...
<input type="hidden" name="fa_x_scan_lhkpn" id= "fa_x_scan_lhkpn" value="0">
...
<input type="hidden" name="fa_x_scan_lhkasn" id= "fa_x_scan_lhkasn" value="0">
...
loadjs.ready("load", function () {
    // Startup script
    $("input[data-field='x_kategori_pemohon']").change((function(){"Wajib LHKPN"==$(this).val()?($("div[id=r_scan_lhkasn]").css({display:"none"}),$("div[id=r_scan_lhkpn]").removeAttr("style")):($("div[id=r_scan_lhkpn]").css({display:"none"}),$("div[id=r_scan_lhkasn]").removeAttr("style"))})),$("div[id=r_scan_lhkpn]").css({display:"none"}),$("div[id=r_scan_lhkasn]").css({display:"none"}),$("div[id=r_keterangan]").css({display:"none"}),$("input[data-field='x_hukuman_disiplin']").change((function(){"Ya"==$(this).val()?$("div[id=r_keterangan]").removeAttr("style"):$("div[id=r_keterangan]").css({display:"none"})}));
});
</script>
