...
loadjs.ready("load", function () {
    // Startup script
    document.body.style.backgroundImage="url('images/kantor-kejati-jatim.jpg')",document.body.style.backgroundPosition="bottom center",document.body.style.backgroundSize="cover",document.body.style.backgroundRepeat="no-repeat",$(".login-box-msg").html("<h3>e-Clearance</h3><span>(Bidang Pengawasan Kejati Jatim)</span>"),$(document).ready((async function(){$("input[name=username]").focus(),Swal.fire({title:"<strong>PENGUMUMAN</strong>",icon:"info",html:"<p>Bagi pemohon Surat Keterangan Kepegawaian agar memperhatikan persyarat sebagai berikut :</p><p>1.\tUntuk pemohon dari Jaksa melampirkan bukti/lembar pengiriman e-LHKPN terbaru sedangkan untuk pegawai Tata Usaha melampirkan e-LHKASN kecuali Bendahara dan PPK tidak diwajibkan. </p><p>2.\tSurat Keterangan Kepegawaian akan diterbitkan ketika persyaratan sudah terpenuhi meskipun ada catatan hukuman disiplin. </p><p>3.\tUntuk Surat Keterangan Kepegawaian yang sudah terbit selain ditembuskan kepada Bidang Pembinaan Kejaksaan Tinggi Jawa Timur juga akan ditembuskan kepada pemohon melalui email pemohon. </p>"}),$("div[class=swal2-content]").css({"text-align":"left"}),$("div[class=swal2-popup]").css({width:"850px !important"})}));
});
</script>
