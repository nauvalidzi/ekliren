...
var fv_pemeriksaedit;
loadjs.ready("head", function () {
    var $ = jQuery;
    // Form object
    currentPageID = ew.PAGE_ID = "edit";
    fv_pemeriksaedit = currentForm = new ew.Form("fv_pemeriksaedit", "edit");

    // Add fields
    var currentTable = <?= JsonEncode(GetClientVar("tables", "v_pemeriksa")) ?>,
        fields = currentTable.fields;
    if (!ew.vars.tables.v_pemeriksa)
        ew.vars.tables.v_pemeriksa = currentTable;
    fv_pemeriksaedit.addFields([
    ...
    // Validate form
    fv_pemeriksaedit.validate = function () {
    ...
    // Form_CustomValidate
    fv_pemeriksaedit.customValidate = function(fobj) { // DO NOT CHANGE THIS LINE!
        // Your custom validation code here, return false if invalid.
        return true;
    }

    // Use JavaScript validation or not
    fv_pemeriksaedit.validateRequired = <?= Config("CLIENT_VALIDATE") ? "true" : "false" ?>;

    // Dynamic selection lists
    fv_pemeriksaedit.lists.status = <?= $Page->status->toClientList($Page) ?>;
    loadjs.done("fv_pemeriksaedit");
});
</script>
<script>
loadjs.ready("head", function () {
...
$Page->showMessage();
?>
<form name="fv_pemeriksaedit" id="fv_pemeriksaedit" class="<?= $Page->FormClassName ?>" action="<?= CurrentPageUrl(false) ?>" method="post">
...
<?php if ($Page->tanggal_request->Visible) { // tanggal_request ?>
    <div id="r_tanggal_request" class="form-group row">
        <label id="elh_v_pemeriksa_tanggal_request" for="x_tanggal_request" class="<?= $Page->LeftColumnClass ?>"><template id="tpc_v_pemeriksa_tanggal_request"><?= $Page->tanggal_request->caption() ?><?= $Page->tanggal_request->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></template></label>
        <div class="<?= $Page->RightColumnClass ?>"><div <?= $Page->tanggal_request->cellAttributes() ?>>
<template id="tpx_v_pemeriksa_tanggal_request"><span id="el_v_pemeriksa_tanggal_request">
...
<input type="hidden" data-table="v_pemeriksa" data-field="x_tanggal_request" data-hidden="1" name="x_tanggal_request" id="x_tanggal_request" value="<?= HtmlEncode($Page->tanggal_request->CurrentValue) ?>">
</div></div>
    </div>
<?php } ?>
<?php if ($Page->nip->Visible) { // nip ?>
    <div id="r_nip" class="form-group row">
        <label id="elh_v_pemeriksa_nip" for="x_nip" class="<?= $Page->LeftColumnClass ?>"><template id="tpc_v_pemeriksa_nip"><?= $Page->nip->caption() ?><?= $Page->nip->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></template></label>
        <div class="<?= $Page->RightColumnClass ?>"><div <?= $Page->nip->cellAttributes() ?>>
<template id="tpx_v_pemeriksa_nip"><span id="el_v_pemeriksa_nip">
...
<input type="hidden" data-table="v_pemeriksa" data-field="x_nip" data-hidden="1" name="x_nip" id="x_nip" value="<?= HtmlEncode($Page->nip->CurrentValue) ?>">
</div></div>
    </div>
<?php } ?>
<?php if ($Page->nrp->Visible) { // nrp ?>
    <div id="r_nrp" class="form-group row">
        <label id="elh_v_pemeriksa_nrp" for="x_nrp" class="<?= $Page->LeftColumnClass ?>"><template id="tpc_v_pemeriksa_nrp"><?= $Page->nrp->caption() ?><?= $Page->nrp->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></template></label>
        <div class="<?= $Page->RightColumnClass ?>"><div <?= $Page->nrp->cellAttributes() ?>>
<template id="tpx_v_pemeriksa_nrp"><span id="el_v_pemeriksa_nrp">
...
<input type="hidden" data-table="v_pemeriksa" data-field="x_nrp" data-hidden="1" name="x_nrp" id="x_nrp" value="<?= HtmlEncode($Page->nrp->CurrentValue) ?>">
</div></div>
    </div>
<?php } ?>
<?php if ($Page->nama->Visible) { // nama ?>
    <div id="r_nama" class="form-group row">
        <label id="elh_v_pemeriksa_nama" for="x_nama" class="<?= $Page->LeftColumnClass ?>"><template id="tpc_v_pemeriksa_nama"><?= $Page->nama->caption() ?><?= $Page->nama->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></template></label>
        <div class="<?= $Page->RightColumnClass ?>"><div <?= $Page->nama->cellAttributes() ?>>
<template id="tpx_v_pemeriksa_nama"><span id="el_v_pemeriksa_nama">
...
<input type="hidden" data-table="v_pemeriksa" data-field="x_nama" data-hidden="1" name="x_nama" id="x_nama" value="<?= HtmlEncode($Page->nama->CurrentValue) ?>">
</div></div>
    </div>
<?php } ?>
<?php if ($Page->unit_organisasi->Visible) { // unit_organisasi ?>
    <div id="r_unit_organisasi" class="form-group row">
        <label id="elh_v_pemeriksa_unit_organisasi" class="<?= $Page->LeftColumnClass ?>"><template id="tpc_v_pemeriksa_unit_organisasi"><?= $Page->unit_organisasi->caption() ?><?= $Page->unit_organisasi->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></template></label>
        <div class="<?= $Page->RightColumnClass ?>"><div <?= $Page->unit_organisasi->cellAttributes() ?>>
<template id="tpx_v_pemeriksa_unit_organisasi"><span id="el_v_pemeriksa_unit_organisasi">
...
<input type="hidden" data-table="v_pemeriksa" data-field="x_unit_organisasi" data-hidden="1" name="x_unit_organisasi" id="x_unit_organisasi" value="<?= HtmlEncode($Page->unit_organisasi->CurrentValue) ?>">
</div></div>
    </div>
<?php } ?>
<?php if ($Page->pangkat->Visible) { // pangkat ?>
    <div id="r_pangkat" class="form-group row">
        <label id="elh_v_pemeriksa_pangkat" for="x_pangkat" class="<?= $Page->LeftColumnClass ?>"><template id="tpc_v_pemeriksa_pangkat"><?= $Page->pangkat->caption() ?><?= $Page->pangkat->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></template></label>
        <div class="<?= $Page->RightColumnClass ?>"><div <?= $Page->pangkat->cellAttributes() ?>>
<template id="tpx_v_pemeriksa_pangkat"><span id="el_v_pemeriksa_pangkat">
...
<input type="hidden" data-table="v_pemeriksa" data-field="x_pangkat" data-hidden="1" name="x_pangkat" id="x_pangkat" value="<?= HtmlEncode($Page->pangkat->CurrentValue) ?>">
</div></div>
    </div>
<?php } ?>
<?php if ($Page->jabatan->Visible) { // jabatan ?>
    <div id="r_jabatan" class="form-group row">
        <label id="elh_v_pemeriksa_jabatan" for="x_jabatan" class="<?= $Page->LeftColumnClass ?>"><template id="tpc_v_pemeriksa_jabatan"><?= $Page->jabatan->caption() ?><?= $Page->jabatan->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></template></label>
        <div class="<?= $Page->RightColumnClass ?>"><div <?= $Page->jabatan->cellAttributes() ?>>
<template id="tpx_v_pemeriksa_jabatan"><span id="el_v_pemeriksa_jabatan">
...
<input type="hidden" data-table="v_pemeriksa" data-field="x_jabatan" data-hidden="1" name="x_jabatan" id="x_jabatan" value="<?= HtmlEncode($Page->jabatan->CurrentValue) ?>">
</div></div>
    </div>
<?php } ?>
<?php if ($Page->scan_lhkpn->Visible) { // scan_lhkpn ?>
    <div id="r_scan_lhkpn" class="form-group row">
        <label id="elh_v_pemeriksa_scan_lhkpn" for="x_scan_lhkpn" class="<?= $Page->LeftColumnClass ?>"><template id="tpc_v_pemeriksa_scan_lhkpn"><?= $Page->scan_lhkpn->caption() ?><?= $Page->scan_lhkpn->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></template></label>
        <div class="<?= $Page->RightColumnClass ?>"><div <?= $Page->scan_lhkpn->cellAttributes() ?>>
<template id="tpx_v_pemeriksa_scan_lhkpn"><span id="el_v_pemeriksa_scan_lhkpn">
...
<input type="hidden" data-table="v_pemeriksa" data-field="x_scan_lhkpn" data-hidden="1" name="x_scan_lhkpn" id="x_scan_lhkpn" value="<?= HtmlEncode($Page->scan_lhkpn->CurrentValue) ?>">
</div></div>
    </div>
<?php } ?>
<?php if ($Page->scan_lhkasn->Visible) { // scan_lhkasn ?>
    <div id="r_scan_lhkasn" class="form-group row">
        <label id="elh_v_pemeriksa_scan_lhkasn" for="x_scan_lhkasn" class="<?= $Page->LeftColumnClass ?>"><template id="tpc_v_pemeriksa_scan_lhkasn"><?= $Page->scan_lhkasn->caption() ?><?= $Page->scan_lhkasn->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></template></label>
        <div class="<?= $Page->RightColumnClass ?>"><div <?= $Page->scan_lhkasn->cellAttributes() ?>>
<template id="tpx_v_pemeriksa_scan_lhkasn"><span id="el_v_pemeriksa_scan_lhkasn">
...
<input type="hidden" data-table="v_pemeriksa" data-field="x_scan_lhkasn" data-hidden="1" name="x_scan_lhkasn" id="x_scan_lhkasn" value="<?= HtmlEncode($Page->scan_lhkasn->CurrentValue) ?>">
</div></div>
    </div>
<?php } ?>
<?php if ($Page->kategori_pemohon->Visible) { // kategori_pemohon ?>
    <div id="r_kategori_pemohon" class="form-group row">
        <label id="elh_v_pemeriksa_kategori_pemohon" class="<?= $Page->LeftColumnClass ?>"><template id="tpc_v_pemeriksa_kategori_pemohon"><?= $Page->kategori_pemohon->caption() ?><?= $Page->kategori_pemohon->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></template></label>
        <div class="<?= $Page->RightColumnClass ?>"><div <?= $Page->kategori_pemohon->cellAttributes() ?>>
<template id="tpx_v_pemeriksa_kategori_pemohon"><span id="el_v_pemeriksa_kategori_pemohon">
...
<input type="hidden" data-table="v_pemeriksa" data-field="x_kategori_pemohon" data-hidden="1" name="x_kategori_pemohon" id="x_kategori_pemohon" value="<?= HtmlEncode($Page->kategori_pemohon->CurrentValue) ?>">
</div></div>
    </div>
<?php } ?>
<?php if ($Page->keperluan->Visible) { // keperluan ?>
    <div id="r_keperluan" class="form-group row">
        <label id="elh_v_pemeriksa_keperluan" for="x_keperluan" class="<?= $Page->LeftColumnClass ?>"><template id="tpc_v_pemeriksa_keperluan"><?= $Page->keperluan->caption() ?><?= $Page->keperluan->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></template></label>
        <div class="<?= $Page->RightColumnClass ?>"><div <?= $Page->keperluan->cellAttributes() ?>>
<template id="tpx_v_pemeriksa_keperluan"><span id="el_v_pemeriksa_keperluan">
...
<input type="hidden" data-table="v_pemeriksa" data-field="x_keperluan" data-hidden="1" name="x_keperluan" id="x_keperluan" value="<?= HtmlEncode($Page->keperluan->CurrentValue) ?>">
</div></div>
    </div>
<?php } ?>
<?php if ($Page->hukuman_disiplin->Visible) { // hukuman_disiplin ?>
    <div id="r_hukuman_disiplin" class="form-group row">
        <label id="elh_v_pemeriksa_hukuman_disiplin" class="<?= $Page->LeftColumnClass ?>"><template id="tpc_v_pemeriksa_hukuman_disiplin"><?= $Page->hukuman_disiplin->caption() ?><?= $Page->hukuman_disiplin->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></template></label>
        <div class="<?= $Page->RightColumnClass ?>"><div <?= $Page->hukuman_disiplin->cellAttributes() ?>>
<template id="tpx_v_pemeriksa_hukuman_disiplin"><span id="el_v_pemeriksa_hukuman_disiplin">
...
<input type="hidden" data-table="v_pemeriksa" data-field="x_hukuman_disiplin" data-hidden="1" name="x_hukuman_disiplin" id="x_hukuman_disiplin" value="<?= HtmlEncode($Page->hukuman_disiplin->CurrentValue) ?>">
</div></div>
    </div>
<?php } ?>
<?php if ($Page->email_pemohon->Visible) { // email_pemohon ?>
    <div id="r_email_pemohon" class="form-group row">
        <label id="elh_v_pemeriksa_email_pemohon" for="x_email_pemohon" class="<?= $Page->LeftColumnClass ?>"><template id="tpc_v_pemeriksa_email_pemohon"><?= $Page->email_pemohon->caption() ?><?= $Page->email_pemohon->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></template></label>
        <div class="<?= $Page->RightColumnClass ?>"><div <?= $Page->email_pemohon->cellAttributes() ?>>
<template id="tpx_v_pemeriksa_email_pemohon"><span id="el_v_pemeriksa_email_pemohon">
...
<input type="hidden" data-table="v_pemeriksa" data-field="x_email_pemohon" data-hidden="1" name="x_email_pemohon" id="x_email_pemohon" value="<?= HtmlEncode($Page->email_pemohon->CurrentValue) ?>">
</div></div>
    </div>
<?php } ?>
<?php if ($Page->keterangan->Visible) { // keterangan ?>
    <div id="r_keterangan" class="form-group row">
        <label id="elh_v_pemeriksa_keterangan" for="x_keterangan" class="<?= $Page->LeftColumnClass ?>"><template id="tpc_v_pemeriksa_keterangan"><?= $Page->keterangan->caption() ?><?= $Page->keterangan->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></template></label>
        <div class="<?= $Page->RightColumnClass ?>"><div <?= $Page->keterangan->cellAttributes() ?>>
<template id="tpx_v_pemeriksa_keterangan"><span id="el_v_pemeriksa_keterangan">
<span<?= $Page->keterangan->viewAttributes() ?>>
<?= $Page->keterangan->EditValue ?></span>
</span></template>
<input type="hidden" data-table="v_pemeriksa" data-field="x_keterangan" data-hidden="1" name="x_keterangan" id="x_keterangan" value="<?= HtmlEncode($Page->keterangan->CurrentValue) ?>">
</div></div>
    </div>
<?php } ?>
<?php if ($Page->status->Visible) { // status ?>
    <div id="r_status" class="form-group row">
        <label id="elh_v_pemeriksa_status" class="<?= $Page->LeftColumnClass ?>"><template id="tpc_v_pemeriksa_status"><?= $Page->status->caption() ?><?= $Page->status->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></template></label>
        <div class="<?= $Page->RightColumnClass ?>"><div <?= $Page->status->cellAttributes() ?>>
<template id="tpx_v_pemeriksa_status"><span id="el_v_pemeriksa_status">
<template id="tp_x_status">
    <div class="custom-control custom-radio">
        <input type="radio" class="custom-control-input" data-table="v_pemeriksa" data-field="x_status" name="x_status" id="x_status"<?= $Page->status->editAttributes() ?>>
...
<?php if ($Page->jenis_hukuman->Visible) { // jenis_hukuman ?>
    <div id="r_jenis_hukuman" class="form-group row">
        <label id="elh_v_pemeriksa_jenis_hukuman" class="<?= $Page->LeftColumnClass ?>"><template id="tpc_v_pemeriksa_jenis_hukuman"><?= $Page->jenis_hukuman->caption() ?><?= $Page->jenis_hukuman->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></template></label>
        <div class="<?= $Page->RightColumnClass ?>"><div <?= $Page->jenis_hukuman->cellAttributes() ?>>
<template id="tpx_v_pemeriksa_jenis_hukuman"><span id="el_v_pemeriksa_jenis_hukuman">
...
<input type="hidden" data-table="v_pemeriksa" data-field="x_jenis_hukuman" data-hidden="1" name="x_jenis_hukuman" id="x_jenis_hukuman" value="<?= HtmlEncode($Page->jenis_hukuman->CurrentValue) ?>">
</div></div>
    </div>
<?php } ?>
<?php if ($Page->hukuman->Visible) { // hukuman ?>
    <div id="r_hukuman" class="form-group row">
        <label id="elh_v_pemeriksa_hukuman" for="x_hukuman" class="<?= $Page->LeftColumnClass ?>"><template id="tpc_v_pemeriksa_hukuman"><?= $Page->hukuman->caption() ?><?= $Page->hukuman->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></template></label>
        <div class="<?= $Page->RightColumnClass ?>"><div <?= $Page->hukuman->cellAttributes() ?>>
<template id="tpx_v_pemeriksa_hukuman"><span id="el_v_pemeriksa_hukuman">
...
<input type="hidden" data-table="v_pemeriksa" data-field="x_hukuman" data-hidden="1" name="x_hukuman" id="x_hukuman" value="<?= HtmlEncode($Page->hukuman->CurrentValue) ?>">
</div></div>
    </div>
<?php } ?>
<?php if ($Page->pasal->Visible) { // pasal ?>
    <div id="r_pasal" class="form-group row">
        <label id="elh_v_pemeriksa_pasal" for="x_pasal" class="<?= $Page->LeftColumnClass ?>"><template id="tpc_v_pemeriksa_pasal"><?= $Page->pasal->caption() ?><?= $Page->pasal->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></template></label>
        <div class="<?= $Page->RightColumnClass ?>"><div <?= $Page->pasal->cellAttributes() ?>>
<template id="tpx_v_pemeriksa_pasal"><span id="el_v_pemeriksa_pasal">
...
<input type="hidden" data-table="v_pemeriksa" data-field="x_pasal" data-hidden="1" name="x_pasal" id="x_pasal" value="<?= HtmlEncode($Page->pasal->CurrentValue) ?>">
</div></div>
    </div>
<?php } ?>
<?php if ($Page->surat_keputusan->Visible) { // surat_keputusan ?>
    <div id="r_surat_keputusan" class="form-group row">
        <label id="elh_v_pemeriksa_surat_keputusan" for="x_surat_keputusan" class="<?= $Page->LeftColumnClass ?>"><template id="tpc_v_pemeriksa_surat_keputusan"><?= $Page->surat_keputusan->caption() ?><?= $Page->surat_keputusan->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></template></label>
        <div class="<?= $Page->RightColumnClass ?>"><div <?= $Page->surat_keputusan->cellAttributes() ?>>
<template id="tpx_v_pemeriksa_surat_keputusan"><span id="el_v_pemeriksa_surat_keputusan">
...
<input type="hidden" data-table="v_pemeriksa" data-field="x_surat_keputusan" data-hidden="1" name="x_surat_keputusan" id="x_surat_keputusan" value="<?= HtmlEncode($Page->surat_keputusan->CurrentValue) ?>">
</div></div>
    </div>
<?php } ?>
<?php if ($Page->sk_nomor->Visible) { // sk_nomor ?>
    <div id="r_sk_nomor" class="form-group row">
        <label id="elh_v_pemeriksa_sk_nomor" for="x_sk_nomor" class="<?= $Page->LeftColumnClass ?>"><template id="tpc_v_pemeriksa_sk_nomor"><?= $Page->sk_nomor->caption() ?><?= $Page->sk_nomor->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></template></label>
        <div class="<?= $Page->RightColumnClass ?>"><div <?= $Page->sk_nomor->cellAttributes() ?>>
<template id="tpx_v_pemeriksa_sk_nomor"><span id="el_v_pemeriksa_sk_nomor">
...
<input type="hidden" data-table="v_pemeriksa" data-field="x_sk_nomor" data-hidden="1" name="x_sk_nomor" id="x_sk_nomor" value="<?= HtmlEncode($Page->sk_nomor->CurrentValue) ?>">
</div></div>
    </div>
<?php } ?>
<?php if ($Page->tanggal_sk->Visible) { // tanggal_sk ?>
    <div id="r_tanggal_sk" class="form-group row">
        <label id="elh_v_pemeriksa_tanggal_sk" for="x_tanggal_sk" class="<?= $Page->LeftColumnClass ?>"><template id="tpc_v_pemeriksa_tanggal_sk"><?= $Page->tanggal_sk->caption() ?><?= $Page->tanggal_sk->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></template></label>
        <div class="<?= $Page->RightColumnClass ?>"><div <?= $Page->tanggal_sk->cellAttributes() ?>>
<template id="tpx_v_pemeriksa_tanggal_sk"><span id="el_v_pemeriksa_tanggal_sk">
...
<input type="hidden" data-table="v_pemeriksa" data-field="x_tanggal_sk" data-hidden="1" name="x_tanggal_sk" id="x_tanggal_sk" value="<?= HtmlEncode($Page->tanggal_sk->CurrentValue) ?>">
</div></div>
    </div>
<?php } ?>
<?php if ($Page->status_hukuman->Visible) { // status_hukuman ?>
    <div id="r_status_hukuman" class="form-group row">
        <label id="elh_v_pemeriksa_status_hukuman" class="<?= $Page->LeftColumnClass ?>"><template id="tpc_v_pemeriksa_status_hukuman"><?= $Page->status_hukuman->caption() ?><?= $Page->status_hukuman->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></template></label>
        <div class="<?= $Page->RightColumnClass ?>"><div <?= $Page->status_hukuman->cellAttributes() ?>>
<template id="tpx_v_pemeriksa_status_hukuman"><span id="el_v_pemeriksa_status_hukuman">
...
<input type="hidden" data-table="v_pemeriksa" data-field="x_status_hukuman" data-hidden="1" name="x_status_hukuman" id="x_status_hukuman" value="<?= HtmlEncode($Page->status_hukuman->CurrentValue) ?>">
</div></div>
    </div>
<?php } ?>
<?php if ($Page->pernah_dijatuhi_hukuman->Visible) { // pernah_dijatuhi_hukuman ?>
    <div id="r_pernah_dijatuhi_hukuman" class="form-group row">
        <label id="elh_v_pemeriksa_pernah_dijatuhi_hukuman" class="<?= $Page->LeftColumnClass ?>"><template id="tpc_v_pemeriksa_pernah_dijatuhi_hukuman"><?= $Page->pernah_dijatuhi_hukuman->caption() ?><?= $Page->pernah_dijatuhi_hukuman->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></template></label>
        <div class="<?= $Page->RightColumnClass ?>"><div <?= $Page->pernah_dijatuhi_hukuman->cellAttributes() ?>>
<template id="tpx_v_pemeriksa_pernah_dijatuhi_hukuman"><span id="el_v_pemeriksa_pernah_dijatuhi_hukuman">
...
<input type="hidden" data-table="v_pemeriksa" data-field="x_pernah_dijatuhi_hukuman" data-hidden="1" name="x_pernah_dijatuhi_hukuman" id="x_pernah_dijatuhi_hukuman" value="<?= HtmlEncode($Page->pernah_dijatuhi_hukuman->CurrentValue) ?>">
</div></div>
    </div>
<?php } ?>
<?php if ($Page->sk_banding_nomor->Visible) { // sk_banding_nomor ?>
    <div id="r_sk_banding_nomor" class="form-group row">
        <label id="elh_v_pemeriksa_sk_banding_nomor" for="x_sk_banding_nomor" class="<?= $Page->LeftColumnClass ?>"><template id="tpc_v_pemeriksa_sk_banding_nomor"><?= $Page->sk_banding_nomor->caption() ?><?= $Page->sk_banding_nomor->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></template></label>
        <div class="<?= $Page->RightColumnClass ?>"><div <?= $Page->sk_banding_nomor->cellAttributes() ?>>
<template id="tpx_v_pemeriksa_sk_banding_nomor"><span id="el_v_pemeriksa_sk_banding_nomor">
...
<input type="hidden" data-table="v_pemeriksa" data-field="x_sk_banding_nomor" data-hidden="1" name="x_sk_banding_nomor" id="x_sk_banding_nomor" value="<?= HtmlEncode($Page->sk_banding_nomor->CurrentValue) ?>">
</div></div>
    </div>
<?php } ?>
<?php if ($Page->tgl_sk_banding->Visible) { // tgl_sk_banding ?>
    <div id="r_tgl_sk_banding" class="form-group row">
        <label id="elh_v_pemeriksa_tgl_sk_banding" for="x_tgl_sk_banding" class="<?= $Page->LeftColumnClass ?>"><template id="tpc_v_pemeriksa_tgl_sk_banding"><?= $Page->tgl_sk_banding->caption() ?><?= $Page->tgl_sk_banding->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></template></label>
        <div class="<?= $Page->RightColumnClass ?>"><div <?= $Page->tgl_sk_banding->cellAttributes() ?>>
<template id="tpx_v_pemeriksa_tgl_sk_banding"><span id="el_v_pemeriksa_tgl_sk_banding">
...
<input type="hidden" data-table="v_pemeriksa" data-field="x_tgl_sk_banding" data-hidden="1" name="x_tgl_sk_banding" id="x_tgl_sk_banding" value="<?= HtmlEncode($Page->tgl_sk_banding->CurrentValue) ?>">
</div></div>
    </div>
<?php } ?>
<?php if ($Page->mengajukan_keberatan_banding->Visible) { // mengajukan_keberatan_banding ?>
    <div id="r_mengajukan_keberatan_banding" class="form-group row">
        <label id="elh_v_pemeriksa_mengajukan_keberatan_banding" class="<?= $Page->LeftColumnClass ?>"><template id="tpc_v_pemeriksa_mengajukan_keberatan_banding"><?= $Page->mengajukan_keberatan_banding->caption() ?><?= $Page->mengajukan_keberatan_banding->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></template></label>
        <div class="<?= $Page->RightColumnClass ?>"><div <?= $Page->mengajukan_keberatan_banding->cellAttributes() ?>>
<template id="tpx_v_pemeriksa_mengajukan_keberatan_banding"><span id="el_v_pemeriksa_mengajukan_keberatan_banding">
...
<input type="hidden" data-table="v_pemeriksa" data-field="x_mengajukan_keberatan_banding" data-hidden="1" name="x_mengajukan_keberatan_banding" id="x_mengajukan_keberatan_banding" value="<?= HtmlEncode($Page->mengajukan_keberatan_banding->CurrentValue) ?>">
</div></div>
    </div>
<?php } ?>
<?php if ($Page->pelanggaran_disiplin->Visible) { // pelanggaran_disiplin ?>
    <div id="r_pelanggaran_disiplin" class="form-group row">
        <label id="elh_v_pemeriksa_pelanggaran_disiplin" for="x_pelanggaran_disiplin" class="<?= $Page->LeftColumnClass ?>"><template id="tpc_v_pemeriksa_pelanggaran_disiplin"><?= $Page->pelanggaran_disiplin->caption() ?><?= $Page->pelanggaran_disiplin->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></template></label>
        <div class="<?= $Page->RightColumnClass ?>"><div <?= $Page->pelanggaran_disiplin->cellAttributes() ?>>
<template id="tpx_v_pemeriksa_pelanggaran_disiplin"><span id="el_v_pemeriksa_pelanggaran_disiplin">
...
<input type="hidden" data-table="v_pemeriksa" data-field="x_pelanggaran_disiplin" data-hidden="1" name="x_pelanggaran_disiplin" id="x_pelanggaran_disiplin" value="<?= HtmlEncode($Page->pelanggaran_disiplin->CurrentValue) ?>">
</div></div>
    </div>
<?php } ?>
<?php if ($Page->inspeksi_kasus->Visible) { // inspeksi_kasus ?>
    <div id="r_inspeksi_kasus" class="form-group row">
        <label id="elh_v_pemeriksa_inspeksi_kasus" class="<?= $Page->LeftColumnClass ?>"><template id="tpc_v_pemeriksa_inspeksi_kasus"><?= $Page->inspeksi_kasus->caption() ?><?= $Page->inspeksi_kasus->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></template></label>
        <div class="<?= $Page->RightColumnClass ?>"><div <?= $Page->inspeksi_kasus->cellAttributes() ?>>
<template id="tpx_v_pemeriksa_inspeksi_kasus"><span id="el_v_pemeriksa_inspeksi_kasus">
...
<input type="hidden" data-table="v_pemeriksa" data-field="x_inspeksi_kasus" data-hidden="1" name="x_inspeksi_kasus" id="x_inspeksi_kasus" value="<?= HtmlEncode($Page->inspeksi_kasus->CurrentValue) ?>">
</div></div>
    </div>
<?php } ?>
<?php if ($Page->tempat_sidang_kode_perilaku->Visible) { // tempat_sidang_kode_perilaku ?>
    <div id="r_tempat_sidang_kode_perilaku" class="form-group row">
        <label id="elh_v_pemeriksa_tempat_sidang_kode_perilaku" class="<?= $Page->LeftColumnClass ?>"><template id="tpc_v_pemeriksa_tempat_sidang_kode_perilaku"><?= $Page->tempat_sidang_kode_perilaku->caption() ?><?= $Page->tempat_sidang_kode_perilaku->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></template></label>
        <div class="<?= $Page->RightColumnClass ?>"><div <?= $Page->tempat_sidang_kode_perilaku->cellAttributes() ?>>
<template id="tpx_v_pemeriksa_tempat_sidang_kode_perilaku"><span id="el_v_pemeriksa_tempat_sidang_kode_perilaku">
...
<input type="hidden" data-table="v_pemeriksa" data-field="x_tempat_sidang_kode_perilaku" data-hidden="1" name="x_tempat_sidang_kode_perilaku" id="x_tempat_sidang_kode_perilaku" value="<?= HtmlEncode($Page->tempat_sidang_kode_perilaku->CurrentValue) ?>">
</div></div>
    </div>
<?php } ?>
<?php if ($Page->hukuman_administratif->Visible) { // hukuman_administratif ?>
    <div id="r_hukuman_administratif" class="form-group row">
        <label id="elh_v_pemeriksa_hukuman_administratif" for="x_hukuman_administratif" class="<?= $Page->LeftColumnClass ?>"><template id="tpc_v_pemeriksa_hukuman_administratif"><?= $Page->hukuman_administratif->caption() ?><?= $Page->hukuman_administratif->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></template></label>
        <div class="<?= $Page->RightColumnClass ?>"><div <?= $Page->hukuman_administratif->cellAttributes() ?>>
<template id="tpx_v_pemeriksa_hukuman_administratif"><span id="el_v_pemeriksa_hukuman_administratif">
...
<input type="hidden" data-table="v_pemeriksa" data-field="x_hukuman_administratif" data-hidden="1" name="x_hukuman_administratif" id="x_hukuman_administratif" value="<?= HtmlEncode($Page->hukuman_administratif->CurrentValue) ?>">
</div></div>
    </div>
<?php } ?>
<?php if ($Page->sidang_kode_perilaku_jaksa->Visible) { // sidang_kode_perilaku_jaksa ?>
    <div id="r_sidang_kode_perilaku_jaksa" class="form-group row">
        <label id="elh_v_pemeriksa_sidang_kode_perilaku_jaksa" class="<?= $Page->LeftColumnClass ?>"><template id="tpc_v_pemeriksa_sidang_kode_perilaku_jaksa"><?= $Page->sidang_kode_perilaku_jaksa->caption() ?><?= $Page->sidang_kode_perilaku_jaksa->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></template></label>
        <div class="<?= $Page->RightColumnClass ?>"><div <?= $Page->sidang_kode_perilaku_jaksa->cellAttributes() ?>>
<template id="tpx_v_pemeriksa_sidang_kode_perilaku_jaksa"><span id="el_v_pemeriksa_sidang_kode_perilaku_jaksa">
...
<input type="hidden" data-table="v_pemeriksa" data-field="x_sidang_kode_perilaku_jaksa" data-hidden="1" name="x_sidang_kode_perilaku_jaksa" id="x_sidang_kode_perilaku_jaksa" value="<?= HtmlEncode($Page->sidang_kode_perilaku_jaksa->CurrentValue) ?>">
</div></div>
    </div>
<?php } ?>
<?php if ($Page->sk_nomor_kode_perilaku->Visible) { // sk_nomor_kode_perilaku ?>
    <div id="r_sk_nomor_kode_perilaku" class="form-group row">
        <label id="elh_v_pemeriksa_sk_nomor_kode_perilaku" for="x_sk_nomor_kode_perilaku" class="<?= $Page->LeftColumnClass ?>"><template id="tpc_v_pemeriksa_sk_nomor_kode_perilaku"><?= $Page->sk_nomor_kode_perilaku->caption() ?><?= $Page->sk_nomor_kode_perilaku->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></template></label>
        <div class="<?= $Page->RightColumnClass ?>"><div <?= $Page->sk_nomor_kode_perilaku->cellAttributes() ?>>
<template id="tpx_v_pemeriksa_sk_nomor_kode_perilaku"><span id="el_v_pemeriksa_sk_nomor_kode_perilaku">
...
<input type="hidden" data-table="v_pemeriksa" data-field="x_sk_nomor_kode_perilaku" data-hidden="1" name="x_sk_nomor_kode_perilaku" id="x_sk_nomor_kode_perilaku" value="<?= HtmlEncode($Page->sk_nomor_kode_perilaku->CurrentValue) ?>">
</div></div>
    </div>
<?php } ?>
<?php if ($Page->tgl_sk_kode_perilaku->Visible) { // tgl_sk_kode_perilaku ?>
    <div id="r_tgl_sk_kode_perilaku" class="form-group row">
        <label id="elh_v_pemeriksa_tgl_sk_kode_perilaku" for="x_tgl_sk_kode_perilaku" class="<?= $Page->LeftColumnClass ?>"><template id="tpc_v_pemeriksa_tgl_sk_kode_perilaku"><?= $Page->tgl_sk_kode_perilaku->caption() ?><?= $Page->tgl_sk_kode_perilaku->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></template></label>
        <div class="<?= $Page->RightColumnClass ?>"><div <?= $Page->tgl_sk_kode_perilaku->cellAttributes() ?>>
<template id="tpx_v_pemeriksa_tgl_sk_kode_perilaku"><span id="el_v_pemeriksa_tgl_sk_kode_perilaku">
...
<input type="hidden" data-table="v_pemeriksa" data-field="x_tgl_sk_kode_perilaku" data-hidden="1" name="x_tgl_sk_kode_perilaku" id="x_tgl_sk_kode_perilaku" value="<?= HtmlEncode($Page->tgl_sk_kode_perilaku->CurrentValue) ?>">
</div></div>
    </div>
<?php } ?>
<?php if ($Page->status_hukuman_kode_perilaku->Visible) { // status_hukuman_kode_perilaku ?>
    <div id="r_status_hukuman_kode_perilaku" class="form-group row">
        <label id="elh_v_pemeriksa_status_hukuman_kode_perilaku" class="<?= $Page->LeftColumnClass ?>"><template id="tpc_v_pemeriksa_status_hukuman_kode_perilaku"><?= $Page->status_hukuman_kode_perilaku->caption() ?><?= $Page->status_hukuman_kode_perilaku->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></template></label>
        <div class="<?= $Page->RightColumnClass ?>"><div <?= $Page->status_hukuman_kode_perilaku->cellAttributes() ?>>
<template id="tpx_v_pemeriksa_status_hukuman_kode_perilaku"><span id="el_v_pemeriksa_status_hukuman_kode_perilaku">
...
<input type="hidden" data-table="v_pemeriksa" data-field="x_status_hukuman_kode_perilaku" data-hidden="1" name="x_status_hukuman_kode_perilaku" id="x_status_hukuman_kode_perilaku" value="<?= HtmlEncode($Page->status_hukuman_kode_perilaku->CurrentValue) ?>">
</div></div>
    </div>
<?php } ?>
</div><!-- /page* -->
    <input type="hidden" data-table="v_pemeriksa" data-field="x_id_request" data-hidden="1" name="x_id_request" id="x_id_request" value="<?= HtmlEncode($Page->id_request->CurrentValue) ?>">
<div id="tpd_v_pemeriksaedit" class="ew-custom-template"></div>
<template id="tpm_v_pemeriksaedit">
<div id="ct_VPemeriksaEdit"><div class="container">
    <div id="r_tanggal_request" class="form-group row">
        ...
        <div class="col-sm-10"><slot class="ew-slot" name="tpx_v_pemeriksa_tanggal_request"></slot></div>
    </div>
    <div id="r_unit_organisasi" class="form-group row">
    ...
    <div id="r_hukuman_disiplin" class="form-group row">
        ...
        <div class="col-sm-10"><slot class="ew-slot" name="tpx_v_pemeriksa_hukuman_disiplin"></slot></div>
    </div>
    ...
    <div id="r_keterangan" class="form-group row">
        ...
        <div class="col-sm-10"><slot class="ew-slot" name="tpx_v_pemeriksa_keterangan"></slot></div>
    </div>
    {{/if}}
    <div class="card shadow">
        ...
        <div class="card-body">
            <div id="r_pernah_dijatuhi_hukuman" class="form-group row">
                ...
                <div class="col-sm-9"><slot class="ew-slot" name="tpx_v_pemeriksa_pernah_dijatuhi_hukuman"></slot></div>
            </div>
            ...
            <div id="r_jenis_hukuman" class="form-group row">
                ...
                <div class="col-sm-9"><slot class="ew-slot" name="tpx_v_pemeriksa_jenis_hukuman"></slot></div>
            </div>
            <div id="r_hukuman" class="form-group row">
                <label id="elh_hukuman" for="x_hukuman" class="col-sm-3 control-label ewLabel"><?= $Page->hukuman->caption() ?></label>
                <div class="col-sm-9"><slot class="ew-slot" name="tpx_v_pemeriksa_hukuman"></slot></div>
            </div>
            <div id="r_pasal" class="form-group row">
                <label id="elh_pasal" for="x_pasal" class="col-sm-3 control-label ewLabel"><?= $Page->pasal->caption() ?></label>
                <div class="col-sm-9"><slot class="ew-slot" name="tpx_v_pemeriksa_pasal"></slot></div>
            </div>
            <div id="r_surat_keputusan" class="form-group row">
            ...
            <div id="r_mengajukan_keberatan_banding" class="form-group row">
                ...
                <div class="col-sm-9"><slot class="ew-slot" name="tpx_v_pemeriksa_mengajukan_keberatan_banding"></slot></div>
            </div>
            {{/if}}
        </div>
    </div>
    <div class="card shadow">
        ...
        <div class="card-body">
            ...
            <div id="r_tgl_sk_banding" class="form-group row">
                ...
                <div class="col-sm-9"><slot class="ew-slot" name="tpx_v_pemeriksa_tgl_sk_banding"></slot></div>
            </div>
            {{/if}}
        </div>
    </div>
    <div class="card shadow">
        ...
        <div class="card-body">
            <div id="r_inspeksi_kasus" class="form-group row">
                ...
                <div class="col-sm-9"><slot class="ew-slot" name="tpx_v_pemeriksa_inspeksi_kasus"></slot></div>
            </div>
            ...
            <div id="r_pelanggaran_disiplin" class="form-group row">
                ...
                <div class="col-sm-9"><slot class="ew-slot" name="tpx_v_pemeriksa_pelanggaran_disiplin"></slot></div>
            </div>
            {{/if}}
        </div>
    </div>
    <div class="card shadow">
        ...
        <div class="card-body">
            <div id="r_sidang_kode_perilaku_jaksa" class="form-group row">
                ...
                <div class="col-sm-9"><slot class="ew-slot" name="tpx_v_pemeriksa_sidang_kode_perilaku_jaksa"></slot></div>
            </div>
            ...
            <div id="r_tempat_sidang_kode_perilaku" class="form-group row">
                ...
                <div class="col-sm-9"><slot class="ew-slot" name="tpx_v_pemeriksa_tempat_sidang_kode_perilaku"></slot></div>
            </div>
            <div id="r_hukuman_administratif" class="form-group row">
                ...
                <div class="col-sm-9"><slot class="ew-slot" name="tpx_v_pemeriksa_hukuman_administratif"></slot></div>
            </div>
            <div id="r_sk_nomor_kode_perilaku" class="form-group row">
                ...
                <div class="col-sm-9"><slot class="ew-slot" name="tpx_v_pemeriksa_sk_nomor_kode_perilaku"></slot></div>
            </div>
            <div id="r_tgl_sk_kode_perilaku" class="form-group row">
                ...
                <div class="col-sm-9"><slot class="ew-slot" name="tpx_v_pemeriksa_tgl_sk_kode_perilaku"></slot></div>
            </div>
            <div id="r_status_hukuman_kode_perilaku" class="form-group row">
                ...
                <div class="col-sm-9"><slot class="ew-slot" name="tpx_v_pemeriksa_status_hukuman_kode_perilaku"></slot></div>
            </div>
            {{/if}}
        </div>
    </div>
    <div class="card shadow">
        ...
        <div class="card-body">
            <div id="r_status" class="form-group row">
                ...
                <div class="col-sm-9"><slot class="ew-slot" name="tpx_v_pemeriksa_status"></slot></div>
            </div>             
        </div>
    </div>
</div>
...
loadjs.ready(["jsrender", "makerjs"], function() {
    ...
    ew.applyTemplate("tpd_v_pemeriksaedit", "tpm_v_pemeriksaedit", "v_pemeriksaedit", "<?= $Page->CustomExport ?>", ew.templateData.rows[0]);
...
loadjs.ready("load", function () {
    // Startup script
    if($(document).ready((function(){var a=$("input[data-field='x_pernah_dijatuhi_hukuman']").val();"Tidak"==a||""==a?$("div[class=input_hukuman]").css({display:"none"}):$("div[class=input_hukuman]").removeAttr("style");var e=$("input[data-field='x_mengajukan_keberatan_banding']").val();"Tidak"==e||""==e?$("div[class=banding]").css({display:"none"}):$("div[class=banding]").removeAttr("style");var s=$("input[data-field='x_inspeksi_kasus']").val();"Tidak"==s||""==s?$("div[class=inspeksi_kasus]").css({display:"none"}):$("div[class=inspeksi_kasus]").removeAttr("style");var l=$("input[data-field='x_sidang_kode_perilaku_jaksa']").val();"Tidak"==l||""==l?$("div[class=sidang_kode_perilaku]").css({display:"none"}):$("div[class=sidang_kode_perilaku]").removeAttr("style")})),$("#el_v_pemeriksa_scan_lhkpn").length){var lhkpn=$("#el_v_pemeriksa_scan_lhkpn input").val();$("#el_v_pemeriksa_scan_lhkpn a input").replaceWith(lhkpn),$("#el_v_pemeriksa_scan_lhkpn a").attr("href","#modal-popup"),$("#modal-popup .modal-title").text(lhkpn),$("#modal-popup .modal-body").append(`<embed src="${base_url}/files/${lhkpn}" frameborder="0" width="100%" height="400px">`),$("#modal-popup .modal-footer").hide()}if($("#el_v_pemeriksa_scan_lhkasn").length){var lhkasn=$("#el_v_pemeriksa_scan_lhkasn input").val();$("#el_v_pemeriksa_scan_lhkasn a input").replaceWith(lhkasn),$("#el_v_pemeriksa_scan_lhkasn a").attr("href","#modal-popup"),$("#modal-popup .modal-title").text(lhkasn),$("#modal-popup .modal-body").append(`<embed src="${base_url}/files/${lhkasn}" frameborder="0" width="100%" height="400px">`),$("#modal-popup .modal-footer").hide()}
});
</script>
