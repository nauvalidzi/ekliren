...
// Page object
$SidangKodePerilakuEdit = &$Page;
?>
<script>
var currentForm, currentPageID;
var fsidang_kode_perilakuedit;
loadjs.ready("head", function () {
    var $ = jQuery;
    // Form object
    currentPageID = ew.PAGE_ID = "edit";
    fsidang_kode_perilakuedit = currentForm = new ew.Form("fsidang_kode_perilakuedit", "edit");
    ...
    fsidang_kode_perilakuedit.addFields([
    ...
    // Set invalid fields
    $(function() {
        var f = fsidang_kode_perilakuedit,
            fobj = f.getForm(),
            $fobj = $(fobj),
    ...
    // Validate form
    fsidang_kode_perilakuedit.validate = function () {
    ...
    // Form_CustomValidate
    fsidang_kode_perilakuedit.customValidate = function(fobj) { // DO NOT CHANGE THIS LINE!
        // Your custom validation code here, return false if invalid.
        return true;
    }

    // Use JavaScript validation or not
    fsidang_kode_perilakuedit.validateRequired = <?= Config("CLIENT_VALIDATE") ? "true" : "false" ?>;

    // Dynamic selection lists
    fsidang_kode_perilakuedit.lists.sidang_kode_perilaku_jaksa = <?= $Page->sidang_kode_perilaku_jaksa->toClientList($Page) ?>;
    fsidang_kode_perilakuedit.lists.tempat_sidang_kode_perilaku = <?= $Page->tempat_sidang_kode_perilaku->toClientList($Page) ?>;
    fsidang_kode_perilakuedit.lists.status_hukuman_kode_perilaku = <?= $Page->status_hukuman_kode_perilaku->toClientList($Page) ?>;
    loadjs.done("fsidang_kode_perilakuedit");
});
</script>
<script>
loadjs.ready("head", function () {
...
$Page->showMessage();
?>
<form name="fsidang_kode_perilakuedit" id="fsidang_kode_perilakuedit" class="<?= $Page->FormClassName ?>" action="<?= CurrentPageUrl(false) ?>" method="post">
...
<script>
loadjs.ready(["fsidang_kode_perilakuedit", "datetimepicker"], function() {
    ew.createDateTimePicker("fsidang_kode_perilakuedit", "x_tgl_sk_kode_perilaku", {"ignoreReadonly":true,"useCurrent":false,"format":0});
});
</script>
<?php } ?>
</span>
...
<?php } ?>
    ...
    <input type="hidden" data-table="sidang_kode_perilaku" data-field="x_id" data-hidden="1" name="x_id" id="x_id" value="<?= HtmlEncode($Page->id->CurrentValue) ?>">
<?php if (!$Page->IsModal) { ?>
