...
$CONFIG = [
    ...
    "RANDOM_KEY" => 'eiDpn3nLDOWsShiN', // Random key for encryption
    "ENCRYPTION_KEY" => '', // Encryption key for data protection
    "PROJECT_STYLESHEET_FILENAME" => "css/eclearance.css", // Project stylesheet file name
    ...
    "BODY_CLASS" => "hold-transition layout-fixed accent-primary",
    "SIDEBAR_CLASS" => "main-sidebar sidebar-dark-primary",
    "NAVBAR_CLASS" => "main-header navbar navbar-expand navbar-dark",
    ...
    // Email
    "SENDER_EMAIL" => "noreply@eclearance.kejati-jatim.go.id", // Sender email address
    "RECIPIENT_EMAIL" => "noreply@eclearance.kejati-jatim.go.id", // Recipient email address
